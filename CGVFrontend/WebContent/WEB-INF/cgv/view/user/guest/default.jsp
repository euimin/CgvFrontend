...
<!-- Mirrored from www.cgv.co.kr/user/guest/default.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 12:20:02 GMT -->
...
<head>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=kOrrMtxLuWGiRjYB0IIDA7EUhoynjc%2bbKguJOggJEgktCxWG0aCQPQBlUer7dLqIJSLz9bp5NwSvr2X0RKIm5UxhWGUwbk5LTHVqTXdMSjBMdXk2bHpsbWIzVXlsZ3U4cTB2SzBiZjR2bGs0L0RIcXF4ZFRNQjVUWjBSeW92SGc%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/guest/default.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fguest%2fdefault.aspx" class="login" ><span>로그인</span></a></li>
...
<div class="wrap-login">
    <div class="sect-login">
		...
		<div class="box-login nomember">
            ...
            <dl class="box-operationguide">
                ...
                <dd><strong>비회원 예매 시 청소년 관람불가 영화는 예매가 제한됩니다.</strong></dd>
                <dd>비회원 예매 결제수단은 신용카드만 가능하며 모든 제휴상품권, 쿠폰, 영화 예매권 등의 사용은 회원 예매 서비스 이용 시 가능합니다. </dd>
                <dd>모바일과 ARS에서는 취소가 불가능 하며, 홈페이지를 이용하여 입력하신 로그인 정보로 취소 처리 하실 수 있습니다.</dd>
                <dd>비회원 예매 및 비회원 예매 확인 / 취소 메뉴만 이용 가능합니다.이 외에  평점, 댓글, 인정 등의 서비스는 회원 가입 후 이용 가능합니다.</dd>
            </dl>
        </div>
    </div>    
    <div class="sect-loginguide">
        <div class="box-useguide">
            ...
            <em>
                <a href="../login/ipin-guide.jsp" class="round black"><span>아이핀 회원 안내</span></a>
            </em>
            <em>
