...
<!-- Mirrored from www.cgv.co.kr/user/login/find-account.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 12:15:20 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="아이디/비밀번호 찾기 &lt; 로그인 | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">아이디/비밀번호 찾기 &lt; 로그인 | 영화 그 이상의 감동. CGV</title>
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2flogin%2ffind-account.aspx" class="login" ><span>로그인</span></a></li>
