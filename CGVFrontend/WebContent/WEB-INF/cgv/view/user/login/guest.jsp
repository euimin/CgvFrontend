...
<head>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=M%2bhrouiSd1eZ5GW72xok6hGkT2Ijx%2fSaqDSf0mfkydhuRXgFMrb3Vj%2fr1YXRN6Qq1YksAPR1oZ2bhIE8RGQ4LzBkbHBwZTVsajdHOEJqTmtZb0htNGxXL1NvY0xGeDRtdGVEZFM0aVg0QkQzcWpwdllXbTBubSsxT0JQT2p4OUs%3d"></script>
</head>
<body class="">
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="login.jsp" class="login" ><span>로그인</span></a></li>
					<li><a href="join.jsp" class="join" ><span>회원가입</span></a></li>
    ...
    <div class="sect-login">
		...
		<div class="box-login nomember">
            ...
            <div class="box-btn">
                ...
                <a class="round inred" href="login-agreement.aspx"><span>비회원예매</span></a>
                <a class="round inblack" href="login.aspx"><span>비회원예매 확인/취소</span></a>
            </div>
