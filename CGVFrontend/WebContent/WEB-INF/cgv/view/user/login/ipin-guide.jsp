...
<!-- Mirrored from www.cgv.co.kr/user/login/ipin-guide.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 12:15:20 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="아이핀 회원안내 &lt; 회원서비스 | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">아이핀 회원안내 &lt; 회원서비스 | 영화 그 이상의 감동. CGV</title>
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2flogin%2fipin-guide.aspx" class="login" ><span>로그인</span></a></li>
					...
					<li><a href="../vip-lounge/index.jsp" class="vip" ><span>VIP LOUNGE</span></a></li>
            ...
            <div class="sect-linemap">
                ...
                <div class="sect-special">
                    <ul>
                        ...
                        <li><a href="../vip-lounge/index.jsp">VIP LOUNGE</a></li>
...
<div class="wrap-ipin">
    <div class="sect-ipin">
        <div class="ipin-info">
            <h3>아이핀 회원안내</h3>
            <p><strong>아이핀(I-PIN) 회원이란?</strong><br />
            아이핀(I-PIN)은 <em>인터넷 개인 식별 번호(Internet Personal Identification Number)</em>의 영문 머리 글자를 따만든 용어입니다.<br />
대면확인이 불가능한 인터넷상에서 주민등록 번호를 대신하여, 본인임을 확인 받을 수 있는 사이버 신원 확인 번호가 아이핀 입니다.</p>
        </div>
        
        <div class="ipin-member">
            <div class="ipin-limit">
	            <h4>아이핀(I-PIN) 회원 가입시 제한되는 서비스</h4>
                <ul>
                    <li>1. 예매, 예매 확인/취소</li>
                    <li>2. 멤버십 카드 등록/관리 및 멤버십 포인트 조회</li>
                    <li>3. 온라인 매점 상품/영화관람권/무비꼴라쥬 패스카드/영화 VOD의 구매 및 구매 내역 조회.</li>
                    <li>4. 관람권 및 쿠폰 등록.</li>
                    <li>5. QOOK 등록.</li>
                    <li>6. 개인정보 관리.</li>
                </ul>
                <a href="http://section.cgv.co.kr/support/faq/Default.aspx?FAQCategoryCode=240&amp;Search_txt=%uC544%uC774%uD540" target="_blank" title="새창" class="round black"><span>아이핀회원 자주찾는 질문</span></a>
                <a href="https://www.cjone.com/cjmweb/join.do?coopco_cd=7010&amp;brnd_cd=1000" target="_blank" title="새창" class="round red"><span>CJ ONE 회원가입</span></a>
            </div><!-- .ipin-limit -->
            <div class="revisionguide">
                <h4>개인정보 취급방침 개정안내</h4>
                <table cellpadding="0" cellspacing="0" summary="기존 개인정보 취급방침 개정안내와 변경된 내용제공">
                    <caption>개인정보 취급방침 개정안내</caption>
                    <colgroup>
                        <col class="col01" />
                        <col class="col02" />
                    </colgroup>
                    ...
                    <tr>
                        <td>
                            <h5>수집하는 개인정보 항목</h5>
                            <p>아이디, 비밀번호, 주민등록 번호, IP, 이메일, 주소, 전화번호, 핸드폰 번호, 이메일/SMS 수신여부, 은행계좌 정보, 신용카드 정보</p>
                            <h5>수집/이용 목적</h5>
                            <p><strong>성명, 아이디, 비밀번호</strong><br />
							회원제 서비스 이용에 따른 본인확인(인증)절차에 이용.</p>
                            <p><strong>주민등록 번호</strong><br />
							중복 가입 및 실명 확인, 이용 가능한 연령의 확인, 비밀번호 분실/아이디 잠김/결제환불 등 고객 서비스 제공, 마케팅, 홍보 등을 위한 고객 분석, 이벤트 경품 제공 시 제세 공과금의 처리, 사내 외 시스템간의 DB 연계키, 온/오프라인 회원 연계의 수단으로 이용.</p>
                            <p><strong>IP </strong><br />
							주민번호 도용 등 개인정보 침해 사고에 대한 대비</p>
                            <p><strong>이메일, 주소, 전화번호, 핸드폰 번호, 이메일, SMS수신 여부</strong><br />
                            공지사항 전달/불만 처리 등을 위한 원활한 의사소통 경로 확보, 신규 서비스 및 신상품 또는 이벤트 정보 등의 안내 및 경품, 물품 배송에 대한 정확한 배송 정보 확보 </p>
                            <p><strong>은행계좌 정보, 신용카드 정보</strong><br />
                            상품 구매에 대한 결제
                            </p>
                        </td>
                        <td>
                            <h5>수집하는 개인정보 항목</h5>
                            <p><strong>기본항목 </strong><br />
                            멤버십 회원가입(계약 성립) 시 요청되는 성명, 아이디, 비밀번호, 주민등록번호, IP, 이메일 주소, 전화번호, 핸드폰 번호, 이메일/SMS 수신여부</p>
                            <p><strong>아이핀으로 회원 가입 시</strong><br />
                            성명, 생년월일, 성별 아이핀 제공 정보(본인 확인 기관이 제공한 정보), 아이디, 비밀번호, 본인 확인 문답, 이메일 주소</p>
                            <p><strong>추가항목</strong><br />
                            은행 계좌 정보, 신용카드 정보(유료 서비스 이용 시), 멤버십 서비스, 포인트 이용 내역 등 기타 멤버십 서비스 이용에 관한 일체의 거래 정보</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
