...
<div id="cgvwrap">
	...
	<form action="<c:url value='/membersJoin.front'/>" method="post" id="joinValid">	
		<tr class="input">
	...
	<!--// 160217 수정 -->
		<td data-handler="checkAll">
			<div id="chk_group" class="chk_group">
				<span style="line-height:3.5em" class="checkbox">
					...
					<input type="checkbox" id="mkt_rcv_all" name="chkall" enabled="enabled"/>
		...
		<td>  
			<input type="submit" name="submit" style="line-height:2.3em;background-color:lightblue;font-weight:bold" value="&nbsp;&nbsp;완료&nbsp;&nbsp;" />&nbsp;
			<input style="line-height:2.3em;background-color:lightblue;font-weight:bold" type="reset" name="reset" value="&nbsp;&nbsp;취소&nbsp;&nbsp;" />  </td>
		</form>
...
/*         // 이메일 직접입력일때
        ...
        $("#email_addr_opt").change(emailDomain);
