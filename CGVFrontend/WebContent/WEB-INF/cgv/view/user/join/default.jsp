...
<!-- Mirrored from www.cgv.co.kr/user/join/default.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 13:09:31 GMT -->
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fjoin%2fdefault.aspx" class="login" ><span>로그인</span></a></li>
					<li><a href="index.jsp" class="join" ><span>회원가입</span></a></li>
...
<div class="wrap-join-2016">
	<div class="join-hd">
		<h3><img src="../../img/R2014/images/common/img_join_hd.jpg" alt="CGV에 오신걸 환영합니다." /></h3>
