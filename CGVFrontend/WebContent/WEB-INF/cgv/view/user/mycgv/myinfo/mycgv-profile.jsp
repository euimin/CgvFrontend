...
<form name="aspnetForm" method="post" action="<c:url value='/profilepicture.front'/>" id="aspnetForm" enctype="multipart/form-data" novalidate="novalidate">
<!-- <div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="sect-profile-img">
                        <div class="box-image">
                            <span class="thumb-image">
                                <img id="img_userprofileimage" src="" alt="회원이름 님 프로필 사진" onerror="errorImage(this, {type:'profile'})" />
                                <span class="profile-mask"></span>
                        ...
                        <div class="box-contents">
                            ...
                            <input type="file" id="profilepicture" name="profilepicture" title="내용" value="${dto.profilepicture }" />
                        </div>
                    </div>
						...
						<table style="width:100%;" summary="개인정보 수집 및 활용 동의 표">
							...
							<tbody>
								<tr>
									...
									<td>
										<ul class="dep1_lst">
											<li class="dep1_lst_li">&middot; 공개된 게시판 서비스의 이미지 등록</li>
											<li class="dep1_lst_li">&middot; 공개된 게시판의 익명성 보장</li>
										</ul>
									</td>
