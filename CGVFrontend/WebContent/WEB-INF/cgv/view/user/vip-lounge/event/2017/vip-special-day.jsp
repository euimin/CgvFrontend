...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/event/2017/vip-special-day.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 20:33:11 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="스페셜 데이 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">스페셜 데이 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV</title>
    ...
    <link rel="stylesheet" href="../../../../../img.cgv.co.kr/event/develop/1612_vip_special_day/event.css" />

    <!--/각페이지 Header End--> 
    <script type="text/javascript">
        //<![CDATA[

        _TRK_CP = "/VIP LOUNGE/스페셜 데이";
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=Y0Z9OexDuAoXdZoeYgoRheOXbU%2fHJU%2bmIZbSvO4uq8IvJyU2Tr3D9iMLZIUdWiUfRsp%2bIpJSqGHyXDwJQei8jWpXY0lSSlBNNis5Y3hnUnF2dWwwUnVERWh6b1p4UWhqM3d3clVDaEZkQmxiV0FjL29nWDZNS2FxMDVQMmNPL24%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/vip-lounge/event/2017/vip-special-day.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fvip-lounge%2fevent%2f2017%2fvip-special-day.aspx" class="login" ><span>로그인</span></a></li>
 ...
 <div class="evt_wrap ir">
        <div class="evt_msg_area">
            ...
            <div class="step1" style="display:none">
                <p>로그인 하시면 지정하신 기념일을 확인하실 수 있습니다.</p>
                <!--로그인 버튼-->
            ...
            <!--로그인 후-->
            <div class="step2">
                <!--1. 고객님이 기념한 설정 알림 메시지-->
                <p class="msg1" style="display:none">
              <!--고객님이 설정하신 기념일은 월 일입니다.-->
                </p>
                <!--2. VIP 등급미달 메시지-->
                ...
                <p class="msg3" style="display:none">
                    <span>고객님의 스페셜데이 쿠폰은</span>
                    
                    <!-- 6월 20일 사용되었습니다-->
                </p>
            </div>
            <p>
                본 이벤트는 당사 사정에 따라 내용이 변경될 수 있습니다<br />
                해당 혜택은 RVIP 이상 등급 회원 중 CJ ONE 회원 예매(CJ ONE 포인트 적립고객)에 한해 지급됩니다<br />
                영화 예매 전 CGV홈페이지>MY CGV>회원정보>CGV서비스 이용동의 설정>기념일에 등록된 날짜 기준으로 쿠폰이 지급됩니다<br />
                CGV서비스 이용동의 및 기념일 이용 동의 설정 시에 한하여 지급됩니다<br />
                쿠폰은 혜택 기간 내 최초 1회 지급되며 지급 후 재발급 되지 않습니다<br />
                쿠폰 유효기간은 설정한 기념일 전후 1주일 내 사용 가능합니다<br />
                예시: 기념일이 6월 20일의 경우 6월 13일 ~ 6월 27일 이내 쿠폰 출력 및 사용 가능<br />
                혜택 기간에서 벗어난 경우 쿠폰 발급이 제한됩니다<br />
                예시: 3월 VIP의 경우 기념일이 2월 28일 설정 후 3월 4일 티켓 출력 시 쿠폰발급 불가<br />
                스페셜 데이는 기념일의 연도와 상관없이 월/일 날짜 기준으로 적용 됩니다<br />
                티켓출력으로 기발급된 스페셜데이 쿠폰의 경우 기념일 전 후 1주일 이내에 한해 사용이가능합니다
            </p>
        </div>
        <!--스페셜 데이 입력하기-->
        <a href="../../../../errae22.jsp" class="btn_special">
            <img src="../../../../../img.cgv.co.kr/event/develop/1612_vip_special_day/btn_special.png" alt="스페셜 데이 입력하기" />
        </a>
    </div>
