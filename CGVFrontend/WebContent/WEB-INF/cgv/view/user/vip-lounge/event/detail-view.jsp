...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/event/detail-view.aspx?idx=15366&page=1 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 15:48:20 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="VIP이벤트 상세 &lt; VIP이벤트 | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">VIP이벤트 상세 &lt; VIP이벤트 | 영화 그 이상의 감동. CGV</title>
...
//<![CDATA[
    ...
    //iframe 제어함(AS-IS에 있던 함수)
    function ifrm(height) {
        //alert("높이:"+height);
        //$('#ifrm').attr("height", height);
        //iframe에서 전달해 주는 높이값 말도 안되는 높이값임... (5000 이런식으로 넘어 옴..)
    }

    //아이프레임 자동제어(AS-IS에 있던 함수)
    function ifrmResize() {
//        var olFrame = document.getElementById("ifrm");
//        try {
//            var oDoc = olFrame.contentDocument || olFrame.contentWindow.document;
//            var frmHeight = "";
//            if (/MSIE/.test(navigator.userAgent)) {
//                frmHeight = oDoc.body.scrollHeight;
//                document.getElementById("ifrm").height = frmHeight + "px";
//            }
//            else {
//                var pageheight = document.getElementById("ifrm").contentDocument.body.offsetHeight;
//                document.getElementById("ifrm").height = pageheight + "px";
//            }
//        }
        //        catch (ex) { }
...
//]]>
    ...
    <script type="text/javascript">
        ...
        _TRK_CP = "/VIP LOUNGE/VIP이벤트/VIP이벤트 상세";
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=ZH%2b3ib5fyinAmRbYf63W%2bU78AFbStG8L8rFI8LHWnXl49WXLUlztDZrSTmVUlpxRet6Wt4HFnBxHtVVSFenyLlNiREhhQU44WmhzZDZtNWxUUXVvSzhqbXBTejdxMFlhakh0Ulh1UGJYRHF1RC9ycWVMV1dPK0h0a0N4Zmt2NWc%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/vip-lounge/event/detail-view.aspx?idx=15366&page=1" />
    </form>
    <script type="text/javascript">
        function cjsso() {
...
<div id="cgvwrap">
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fvip-lounge%2fevent%2fdetail-view.aspx%3fidx%3d15366%26page%3d1" class="login" ><span>로그인</span></a></li>
    ...
    <div class="cols-content vip-event-view">
...
<head>
    <meta charset="utf-8" />
    <title></title>
    <link rel="stylesheet" href="../../../../img.cgv.co.kr/event/develop/1612_vip_point_save/event.css" />
</head>
<body>
    <div class="evt_wrap ir">
        <h4>2017 CGV VIP 더블적립 & 리필적립</h4>
        <p>VIP 고객님께 드리는 포인트 추가 적립 혜택!</p>
        <h5 id="evt_section1">01 VIP 더블적립</h5>
        <p>매주 수요일, 영화 관람 시 관람 포인트만큼 CJ ONE 포인트 더블 적립 (상영일 기준) 기본 적립 5% + 더블 적립 5%</p>
        <p>CJ OEN 고객님, 생일에 영화 관람하시면 CGV콤보가 무료!</p>
        <p>
            참여대상:2017년 CGV VIP / RVIP / VVIP / SVIP 고객
            이용기간:2017년 CGV VIP 등급 유지 기간
        </p>
        <h5 id="evt_section2">02 VIP 리필적립</h5>
        <p>VIP 등급 유지 기간 동안 구매누적포인트 14,000P 달성 후 추가 관람하면 다음 달부터 영화 관람 시마다 CJ ONE 포인트 추가 적립 (등급별 적립률 상이) 기본 적립 5%</p>
        <p>
            RVIP 1%,VVIP 3%,SVIP 5%
        </p>
        <p>
           참여대상: 2017년 CGV RVIP / VVIP / SVIP 고객
           이용기간: 2017년 CGV VIP 등급 유지 기간
        </p>
        ...
        <h6>01_VIP 더블적립</h6>
        <p>
            최종 티켓가가 아닌 실 결제 금액 기준으로 포인트가 적립되며, 결제 금액의 5%는
            기본 관람 포인트로, 추가 5%는 이벤트 포인트로 적립됩니다.
            (추가 더블 적립 포인트는 차년도 VIP 선정에 미포함)
            포인트 유효기간은 지급일로부터 24개월입니다.
            관람 포맷 및 상영관, 좌석 종류에 무관하게 적용 가능합니다.
            공휴일에도 적용됩니다.
            등급 조정 기간에는 더블 적립이 불가합니다.
        ...
        <p>
            ...
            최종 티켓가가 아닌 실 결제 금액 기준으로 포인트가 적립되며, 결제 금액의 5%는
            기본 관람 포인트로, 추가 적립은 이벤트 포인트로 적립됩니다.
            (추가 적립 포인트는 차년도 VIP 선정에 미포함)
            14,000p 달성한 익월 5일(상영일 기준)부터 리필적립이 진행됩니다.
            (예. 17년 4월에 14,000p 달성 시, 5월 5일 관람 내역부터 등급별 적립률에 따라 추가 적립 진행)
            포인트 유효기간은 지급일로부터 24개월입니다.
            관람 포맷 및 상영관, 좌석 종류에 무관하게 적용 가능합니다.
            등급 조정 기간에는 추가 적립이 불가합니다.
            본 이벤트는 당사 사정에 따라 내용이 변경될 수 있습니다.
...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/event/detail-view.aspx?idx=15366&page=1 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 15:48:20 GMT -->
            ...
            <div class="tbl-viw-nav">
                <div class="dir-prev">
                    <a href="index2679.jsp?page=1">목록</a>
                </div>
            </div>
...
//<![CDATA[
    (function ($) {
        $(function () {
            ...
            //댓글 있을 경우
            $('#ifrm_Vipevent_comment').load(function() {
                $(this).css("height", $(this).contents().find("body").height() + "px");
            });
        });
...
<script type="text/javascript">
    var _TRK_PI = 'EVTP';
    var _TRK_ICMP = '15366';
    var _TRK_ICMP_NM = 'VIP 더블적립';
    var _TRK_ICMP_PS = '20170110';
    var _TRK_ICMP_PE = '20171231';
</script>
