...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/event/2017/vip-special-gift.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 20:33:08 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="스페셜 기프트 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">스페셜 기프트 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV</title>
    ...
    <!-- 각페이지 Header Start--> 
       ...
       <link rel="stylesheet" href="../../../../../img.cgv.co.kr/event/develop/1612_vip_special_gift/event.css" />

    <!--/각페이지 Header End--> 
    <script type="text/javascript">
        //<![CDATA[

        _TRK_CP = "/VIP LOUNGE/스페셜 기프트";
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=KjcCdheXWTLbfjsII3RTNWo%2f2s14j5wJ%2fs7upgk2zn6UvZs6nIIBlTX%2fi%2bldffZ8rZ0hMFKSJZiqY%2bFsDipHi1liV0lKV1VUazVFME1DWlgyUHd3WWVoTWUveUVWMkswZ2VLWi9LZ1JiR2svS3ptNFNNK1h5RHdTcEtDWC9Bd0E%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/vip-lounge/event/2017/vip-special-gift.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
...
<div id="cgvwrap">
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fvip-lounge%2fevent%2f2017%2fvip-special-gift.aspx" class="login" ><span>로그인</span></a></li>
  ...
  <div class="evt_wrap ir">
        <h4>2017 CGV VIP SPECIAL GIFT VIP BENEFIT</h4>
        <p>SVIP, VVIP 고객님께만 드리는 특별한 선물!</p>
        <p>
            수령일자 : 17. 2. 13 (월) ~ 등급 유지 기간 내<br />
            수령장소 : 첫 번째 ‘자주가는 CGV’
        </p>
        <h5>북 무드등 (SVIP 한정)</h5>
        <p>
            SVIP 고객님만을 위한 한정 아이템.
            고급스러운 책 같지만, 펼치면 은은한 조명이 켜지는
            북 무드등으로 USB 전원으로 충전 가능하며 360˚까지
            펼칠 수 있어 다양하게 활용 가능 (USB 케이블 포함)
        </p>
        <h5>원데이 프리패스 (SVIP/VVIP 혜택 상이)</h5>
        <p>
            원하는 단 하루, CGV에서 영화를 무제한으로
            관람할 수 있는 원데이 프리패스 카드.
            SVIP와 VVIP의 원데이 프리패스 사용 혜택이 다르므로
            사용 전, 유의사항 확인은 필수!
        </p>
        <!--원데이 프리패스 자세히 보기 버튼-->
        <a href="vip-one-day.jsp" class="btn_detail">
            <img src="../../../../../img.cgv.co.kr/event/develop/1612_vip_special_gift/btn_detail.png" alt="원데이 프리패스 자세히 보기" />
        </a>
        <h5>SVIP/VVIP 전용 CJ ONE 카드 </h5>
        <p>
            고객님의 등급이 새겨진
            SVIP/ VVIP 전용 CJ ONE 카드.
            2017년 SVIP/VVIP 고객님만 받을 수 있는
            특별 한정 아이템.
        </p>
        <h6>수령방법</h6>
        <p>
            홈페이지/모바일앱 MY CGV > ‘자주가는 CGV’ 또는 하단 CGV 확인하기
            수령장소 변경 희망 시 MY CGV에서 ‘자주가는 CGV’변경 
            17. 2. 13 (월) 부터 설정된 수령장소로 방문 후 스페셜기프트 수령
        </p>
        <p>
            1. 22 (일) 오전 10시 기준 첫 번째 ‘자주가는 CGV’로 수령장소가 설정됨
            수령 시 본인 신분증 지참 필수 (대리 수령 불가)
        </p>
        <div class="evt_msg_area">
            <!--로그인 전-->
            <div class="step1" style="display:none">
                <p>로그인 하시면 첫 번째 '자주가는 CGV'를 확인 하실 수 있습니다.</p>
                <!--로그인 버튼-->
                <a href="javascript:goLogin();" class="btn_login">
                    <img src="../../../../../img.cgv.co.kr/event/develop/1612_vip_special_gift/btn_login.png" alt="로그인 하기"/>
                </a>
            </div>
            <!--로그인 후-->
            <div class="step2" style="display:none">
                <!--1. 고객님이 자주가는 CGV-->
                <p class="msg1" style="display:none">
            ...
            <p>
                SPECIAL GIFT는 17년 SVIP/VVIP 고객에 한하여 수령 가능합니다<br />
                SVIP와 VVIP의 SPECIAL GIFT 구성이 상이합니다.<br />
                SPECIAL GIFT는 고객별 등급 유지 기간 내 지급되며, 등급 변경 및 갱신 이후 수령은 불가합니다.<br />
                SPECIAL GIFT는 본인에 한해 1회 지급되며 대리 수령은 불가합니다.<br />
                (수령 시 신분증을 확인하오니 지참 바랍니다.)<br />
                SPECIAL GIFT는 상기 이미지와 다를 수 있으며 교환 및 반품이 불가합니다.<br />
                고객님의 설정된 ‘자주가는 CGV’가 아닌 다른 CGV로 방문 시 GIFT 수령이 어려울 수 있습니다.<br />
                1/22(월) 오전 10시 기준으로 고객님의 첫 번째 ‘자주가는 CGV’로 수령 장소가 설정되며, 설정되어<br />
                있지 않다면 가장 최근에 방문한 CGV극장으로 자동 설정됩니다.<br />
                ‘자주가는 CGV’설정방법 : CGV홈페이지/APP > MY CGV > ‘ 자주가는 CGV’에서 설정 가능합니다.
            </p>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function goLogin() {
            location.href = "http://www.cgv.co.kr/user/login/?returnURL=" + location.href; return false;
        }
