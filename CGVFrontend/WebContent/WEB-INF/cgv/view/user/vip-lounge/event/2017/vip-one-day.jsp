...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/event/2017/vip-one-day.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 20:33:10 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="원데이프리패스카드 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">원데이프리패스카드 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV</title>
    ...
    <link rel="stylesheet" href="../../../../../img.cgv.co.kr/event/develop/1612_vip_one_day/event.css" />

    <!--/각페이지 Header End--> 
    <script type="text/javascript">
        //<![CDATA[

        _TRK_CP = "/VIP LOUNGE/원데이프리패스카드";
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=kOrrMtxLuWGiRjYB0IIDA7EUhoynjc%2bbKguJOggJEgktCxWG0aCQPQBlUer7dLqIJSLz9bp5NwSvr2X0RKIm5UxhWGUwbk5LTHVqTXdMSjBMdXk2bDJYdjBWVTdPYlRDQ29YQ3pVaUdDVXAxOG1oaXMyc3FEbVl4Nk5EY0VvMUc%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/vip-lounge/event/2017/vip-one-day.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
...
<div id="cgvwrap">
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fvip-lounge%2fevent%2f2017%2fvip-one-day.aspx" class="login" ><span>로그인</span></a></li>
    ...
    <div class="evt_wrap ir">
        <h4>2017 CGV VIP 원데이 프리패스</h4>
        <p>SVIP, VVIP 고객님께만 드리는 1일 영화 무제한 관람 혜택 원하는 단 하루, CGV에서 마음껏 관람하자!</p>
        <p>SVIP - 일반 2D 무료 (동반 1인/주말 가능)</p>
        <p>VVIP - 평일 2D 무료 (본인 한정/주말,공휴일 제외)</p>
        <p>
            참여대상:2017년 CGV SVIP & VVIP 고객 (등급별 혜택 상이)
            이용기간:등급 유지 기간 중 사용 가능
            사용방법:스페셜 기프트 수령 후 매표소에 ‘원데이 프리패스 카드’ 제시 (2월 말 부터 스페셜 기프트 수령 가능)
        </p>
        <div class="btn_area">
            <!--스페셜 기프트 자세히 보기 버튼-->
            <a href="vip-special-gift.jsp">
                <img src="../../../../../img.cgv.co.kr/event/develop/1612_vip_one_day/btn_gift.png" alt="스페셜 기프트 자세히 보기" />
            </a>
        </div>
        <div class="evt_msg_area">           
            <!--로그인 전-->
            <div class="step1" style="display:none">
                <p>로그인 하시면 고객님의 원데이 프리패스 사용 여부를 확인 하실 수 있습니다.</p>
                <!--로그인 버튼-->
                <a href="javascript:goLogin();" class="btn_login">
                    <img src="../../../../../img.cgv.co.kr/event/develop/1612_vip_special_day/btn_login.png" alt="로그인 하기"/>
                </a>
            </div>
            <!--로그인 후-->
            <div class="step2">
                ...
                <!--2. 프리패스 카드 사용 완료-->
                <p class="msg2" style="display:none">
                    <span>   </span>
                  
                </p>
                <!--3. 스페셜 데이 쿠폰발행 및 사용시-->
                <p class="msg3" style="display:none">
                    <span></span>
            ...
            <h5>꼭 확인하세요</h5>
            <p>
                SVIP 프리패스는 주말/평일 사용 가능, VVIP 프리패스는 평일만(공휴일 제외) 사용 가능<br />
                SVIP 프리패스는 동반 1인까지 적용 가능, VVIP프리패스는 본인에 한해 이용 가능<br />
                고객 등급 유지 기간 만료되어 등급 갱신 시 상품 수령 및 이용 불가<br />
                극장 매표소에서 카드를 등록하시는 당일에 한해 관람이 가능 (사전 등록 불가)<br />
                등록 시점부터 익일 오전 05:59까지 상영되는 영화만 적용 가능<br />
                (단, 24시 이후 영화는 23:59까지 발권 가능)<br />
                본인에 한해 1회 1매, 일 최대 10매에 한함 (신분증 확인 필수)<br />
                일반관/IMAX/4DX/아트하우스관에서 상영하는 일반 2D 영화 사용 가능<br />
                (2D SOUNDX/2D SOUNDX-MIX 영화 포함)<br />
                3D/IMAX/4DX/STARIUM/GOLD CLASS/SWEETBOX/아트하우스 톡프로그램 제외<br />
                CJ ONE 포인트 적립 불가 및 타 제휴 할인과 중복 사용 불가<br />
                프리패스 등록한 1개 극장에 한해 이용 가능<br />
                원데이 프리패스 재판매 행위 적발 시 회원 탈퇴, 등급 박탈 등 불이익이 제공될 수 있습니다<br />
