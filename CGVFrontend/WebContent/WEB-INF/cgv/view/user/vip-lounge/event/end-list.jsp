...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/event/end-list.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 15:46:46 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="종료된 이벤트 &lt; VIP이벤트 | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">종료된 이벤트 &lt; VIP이벤트 | 영화 그 이상의 감동. CGV</title>
    ...
    <script type="text/javascript">
        ...
        _TRK_CP = "/VIP LOUNGE/VIP이벤트/종료된 이벤트";
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=LCbpA8KB3PbC2f1%2ff%2bbmp8bDgFCRfa%2fBc%2bXoOFcOrXzwJaFpeDE8bcdiMq%2f8PNFdaXUNTlOk2PD3QcvTSXU9%2fU42WWFNSlpCbW5UU0c4YTZIQTc1V1Z6eFNYem9GZ21EaytnMXpSTkRwSnhhYVF4KzExTGg1UjRVeW9aNVNCQWQ%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/vip-lounge/event/end-list.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fvip-lounge%2fevent%2fend-list.aspx" class="login" ><span>로그인</span></a></li>
...
<div class="cols-content vip-end-event">


            <div class="col-detail">
                <div class="tit-evt vip">
                    <h3>종료된 이벤트</h3>
                    <div class="set-btn">
                        <a href="winner/list.jsp" class="round red on"><span>당첨자 발표</span></a>
                    </div>
                </div>
                
                <div class="sect-evt-entlist vip">
                    <ul>
                         
                                <li>
                                    <div class="box-image">
                                        <a href="detail-view74e8.jsp?idx=16307">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2017/0615/240_200.jpg" alt="멤버십 2017 CGV VIP 쿠킹클래스 6월"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-view4d7c.jsp?idx=16307&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong>2017 CGV VIP 쿠킹클래스 6월</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-viewd7fc.jsp?idx=16255">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2017/0601/240x200(3).jpg" alt="멤버십 <박열> CGV VIP 시사회"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-vieweac9.jsp?idx=16255&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong><박열> CGV VIP 시사회</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-viewd1dd.jsp?idx=16184">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2017/0518/main_banner_240X200_b(1).jpg" alt="멤버십 <대립군> CGV VIP 시사회"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-viewc1a7.jsp?idx=16184&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong><대립군> CGV VIP 시사회</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-view780e.jsp?idx=16133">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2017/0511/240_200.jpg" alt="멤버십 2017 CGV VIP 쿠킹클래스 5월"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-view9988.jsp?idx=16133&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong>2017 CGV VIP 쿠킹클래스 5월</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-view6289.jsp?idx=15924">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2017/0417/1150x180_01.jpg" alt="멤버십 에이리언 DAY VIP  시사회"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-viewf1d3.jsp?idx=15924&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong>에이리언 DAY VIP 시사회</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-view58e6.jsp?idx=15934">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2017/0411/main_banner_240X200.jpg" alt="멤버십 <특별시민> 스페셜 관람권 & 포토티켓 이벤트"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-view929b.jsp?idx=15934&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong><특별시민> 스페셜 관람권 & 포토티켓 이벤트</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                            2017.04.11 ~ 2017.04.26
                                        </em>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-viewa603.jsp?idx=15897">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2017/0404/240_200(1).jpg" alt="멤버십 2017 CGV VIP 쿠킹클래스 4월"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-viewe284.jsp?idx=15897&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong>2017 CGV VIP 쿠킹클래스 4월</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-viewc760.jsp?idx=14028">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2016/0324/web_cjonepoint_listbanner.jpg" alt="멤버십 [2016 CGV VIP회원]CJ ONE 포인트 반값 할인! "/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-view71e7.jsp?idx=14028&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong>[2016 CGV VIP회원]CJ ONE 포인트 반값 할인! </strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                            2016.03.24 ~ 2017.02.28
                                        </em>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-view40ba.jsp?idx=13937">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2016/0303/web_2016coupon_240_200_2.jpg" alt="멤버십 2016 CGV VIP 온라인 쿠폰북 오픈! "/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-view99cb.jsp?idx=13937&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong>2016 CGV VIP 온라인 쿠폰북 오픈! </strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                            2016.03.03 ~ 2017.02.28
                                        </em>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="detail-view7208.jsp?idx=13936">
                                            <span class="thumb-image">
                                                <img onerror="errorImage(this)" src="../../../../img.cgv.co.kr/Event/Event/2016/0303/web_special_day_listbanner.jpg" alt="멤버십 [SPECIAL DAY]에이드 2잔 무료!"/>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="detail-view9f50.jsp?idx=13936&amp;page=1">
                                            <em class="txt-lightblue">멤버십</em>
                                            <strong>[SPECIAL DAY]에이드 2잔 무료!</strong>
                                        </a>
                                        <em class="date">
                                            <span>기간: </span>
                                            2016.03.03 ~ 2017.02.28
...
<div class="paging">
  <ul>
    ...
    <li>
      <a href="end-list4658.jsp?page=2">2</a>
    </li>
    <li>
      <a href="end-list9ba9.jsp?page=3">3</a>
    </li>
    <li>
      <a href="end-listfdb0.jsp?page=4">4</a>
    </li>
    <li>
      <a href="end-listaf4d.jsp?page=5">5</a>
    </li>
  </ul>
  <button class="btn-paging next" type="button" onclick="location='/user/vip-lounge/event/end-list.aspx?page=5'">다음</button>
  <button class="btn-paging end" type="button" onclick="location='/user/vip-lounge/event/end-list.aspx?page=5'">끝</button>
</div>
...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/event/end-list.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 15:48:03 GMT -->
</html>