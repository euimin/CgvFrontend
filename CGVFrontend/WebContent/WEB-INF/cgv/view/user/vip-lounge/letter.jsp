...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/letter.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 13:02:50 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="VIP전용레터 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">VIP전용레터 &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV</title>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=FyIC7Pnp5iPYbZj%2b76ozT5YxW%2f8N72Ry%2b5M408HS19QUIFmCOtvIybPgj3tNrPCp%2fsxTzZnEVNYFgF%2fEROD0tk5YUmRvQ3hoeWtRbUhLNFBTQ3lLR3VjdGZuU1ZrcjVGRGJJKzFZVW5tRlNtUXErdXN3Vmt6eGFWOGRVcW5VY1I%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/vip-lounge/letter.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fvip-lounge%2fletter.aspx" class="login" ><span>로그인</span></a></li>
...
<div class="cols-content vip-letter">
    
<div class="col-aside vip">
    <h2>VIP LOUNGE</h2>
    <div class="snb">
        <ul>
            <li><a href="index.jsp" title="현재선택">VIP HOME<i></i></a></li>
            <li><a href="event/index.jsp" >VIP 이벤트<i></i></a></li>
            <!-- <li class='on'><a href="/user/vip-lounge/letter.aspx" >VIP 전용레터<i></i></a></li> -->
            <li class="required-login snb-last" data-url="/user/vip-lounge/coupon.aspx"><a href="../login/index17eb.jsp" >나의 VIP쿠폰<i></i></a></li>
        </ul>
        <a href="faq.jsp" class="snb-cs"><img src="../../img/R2014/images/common/btn/btn_vip_cs_center.png" alt="VIP 고객센터 고객님, 무엇을 도와 드릴까요?"/></a>
    </div>
    <div class="ad-vip">
    ...
    <div class="col-detail">
        <img src="../../img/R2014/images/title/tit_vip_letter.png" alt="VIP Letter" />
        
        <div class="vip_letter_frame">
            <iframe id="ifrm_vip_letter" name="ifrm_vip_letter" src="http://img.cgv.co.kr/mail/vip_letter/vip_1507_vol28.jsp" width="100%" height="1828px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        $(function () {
            $(".item-wrap ul li a").each(function () {
                $(this).click(function () {
                    $('.item-wrap ul li').removeClass('on')
                    $(this).closest('li').addClass('on')
                    //&(this).addTag('title="현재선택됨"')
                    var letterUrl = $(this).attr('href')
                    $('#ifrm_vip_letter').attr('src', letterUrl)
                    return false
                });
            });
        });
...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/letter.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 13:02:54 GMT -->
</html>