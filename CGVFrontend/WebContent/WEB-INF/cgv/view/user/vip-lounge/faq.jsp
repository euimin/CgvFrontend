...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/faq.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 12:20:38 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="VIP FAQ &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">VIP FAQ &lt; VIP LOUNGE | 영화 그 이상의 감동. CGV</title>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=KjcCdheXWTLbfjsII3RTNWo%2f2s14j5wJ%2fs7upgk2zn6UvZs6nIIBlTX%2fi%2bldffZ8rZ0hMFKSJZiqY%2bFsDipHi1liV0lKV1VUazVFME1DWlgyUHd3WVNHcy92M2JrQzhWcDF0b1RhdENjaWYwQ1FkNXhBSDRlTDhkSFhtVEl2MFg%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/user/vip-lounge/faq.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
...
<div id="cgvwrap">
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../login/index04d2.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fuser%2fvip-lounge%2ffaq.aspx" class="login" ><span>로그인</span></a></li>
					<li><a href="../join/index.jsp" class="join" ><span>회원가입</span></a></li>
                    
                

					<li><a href="../mycgv/index.jsp" class="mycgv required-login" data-url="/user/mycgv/" ><span>MY CGV</span></a></li>
					<li><a href="index.jsp" class="vip" ><span>VIP LOUNGE</span></a></li>
					<li><a href="../memberShip/ClubService.jsp" title="새창" class="club specialclub"  ><span>CLUB 서비스</span></a></li>
					<!-- 2014.12.8 리뉴얼-->
            ...
            <div class="im-wrap"> <!-- Important wrap -->
				<h2><img src="../../img/R2014/images/title/h2_viplounge.png" alt="VIP LOUNGE" /></h2>
							...
							<div class="sub-wrap">
								...
								<div class="smenu">
									<ul>
										...
										<li class="last"><a href="../memberShip/ClubService.jsp" title="새창" class="specialclub" >Club서비스</a></li>
									</ul>
								</div>
							</div>
						</li>
            ...
            <div class="sect-linemap">
                ...
                <div class="sect-special">
                    <ul>
                        ...
                        <li><a href="index.jsp">VIP LOUNGE</a></li>
                        <li><a href="../memberShip/ClubService.jsp" title="새창" class="specialclub">Club서비스</a></li>
    ...
    <div class="cols-content vip-help">
 

        <div class="col-detail">
            <h3>VIP FAQ</h3>
            <p>고객님께서 궁금하신 내용을 먼저 확인해 주세요.</p>
            <div class="srh-vip">
                <form>
                    <fieldset>
                        <legend>검색어를 입력하는 영역입니다.</legend>
                        <p>
                            <label class="hidden" for="searchtext">VIP 문의사항</label>
                            <input type="text" class="medium" id="searchtext" name="searchtext" minlength="2" maxlength="20" value="" placeholder="궁금하신 내용을  입력해주세요"/>
                            <button type="button" class="round inblack" id="btn_search"><span>검색하기</span></button>
                        </p>
                    </fieldset>
                </form>
            </div>
            ...
            <div class="tbl-data">
                <ul>
                            ...
                            <li>
                                <p>
                                    <em>17</em>
                                    <a href="#" class="question">VIP 선정이 월별로 진행되면 매월 VIP가 되는 건가요?</a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        <P>아닙니다 선정 시점이 매월로 변경될 뿐 선정이 되고 나서 VIP 유지 기간은 1년으로 동일합니다<BR>일반등급의 고객님에 한해 매월 구매 누적 포인트를 집계하고 VIP 고객님에 대해서는 VIP 등급을 획득하신 시점부터</P>
<P>다시 선정 포인트를 집계하게 됩니다</P>
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                <p>
                                    <em>16</em>
                                    <a href="#" class="question">일반 고객의 VIP 선정 최근 1년의 정확한 날짜 기준이 궁금합니다</a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        <P>일반고객의 선정 시점은 최근 1년 월별 선정이며 만약 17년 4월 VIP 이면 </P>
<P>16년 4월 1일~17년 3월 31일까지의 선정 포인트 기준으로 집계합니다</P>
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                            ...
                            <li>
                                <p>
                                    <em>15</em>
                                    <a href="#" class="question">VIP 선정 포인트 기준을 알고 싶어요</a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        CGV에서 구매한 누적포인트를 기준으로 기존과 동일하게 영화관람(5%), 매점이용(2%), 씨네샵이용(2%) 입니다. 추가적으로 일반적인 이벤트 등을 통해서 적립한 포인트는 제외됩니다
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                            ...
                            <li>
                                <p>
                                    <em>14</em>
                                    <a href="#" class="question">구매 누적 포인트와 이벤트 포인트의 차이점이 뭔가요? </a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        <P>&nbsp;- 구매 누적 포인트</P>
<P>&nbsp; : &nbsp;고객님께서 CGV에서 유료로 영화 티켓 구매 또는 매점/씨네샵 구매 시 적립하신 CJ ONE 포인트 총합입니다</P>
<P><BR>&nbsp;- 이벤트 누적 포인트(VIP 선정 제외)</P>
<P>&nbsp;&nbsp;: 구매 누적 포인트 이외의 모든 누적포인트는 이벤트 누적 포인트입니다<BR>&nbsp;&nbsp;&nbsp; (예 : CGV 이벤트 참여 후 받은 포인트, VIP 추가 포인트, 설문 완료 후 지급 포인트 등) </P>
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                            ...
                            <li>
                                <p>
                                    <em>13</em>
                                    <a href="#" class="question">영화관람/매점이용/씨네샵이용의 정확한 VIP 적립 기준을 알고 싶어요</a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        <P>VIP 선정 반영되는 적립 포인트 기준은 VIP선정 기준 적립일이며, CJ ONE 가용일자와 상이할 수 있습니다<BR>자세한 포인트 적립조회는 MY CGV &gt; CJ ONE포인트 이력조회를 통해 확인하시기 바랍니다</P>
<P>&nbsp;</P>
<P><STRONG>■ 매표 구매 누적 포인트</STRONG><BR>&nbsp;- CGV영화 관람을 통해 적립되는 포인트로 상영일 기준으로 누적 적립되며 온라인 상에서 실제 누적포인트 반영까지 최대 3일 소요됩니다 (30시간 기준)</P>
<P><STRONG>■ 매점&amp;씨네샵 구매 누적 포인트</STRONG><BR>&nbsp;- CGV매점 또는 씨네샵에서 구매 후, 고객이 직접 적립 진행 시 제공되는 포인트로 적립 당일일자(24시간 기준)로 누적 적립되며 실제 온라인 누적포인트 반영까지 적립일로부터 최대 3일 소요됩니다</P>
<P><STRONG>■ VIP 선정 포함되는 이벤트 포인트</STRONG><BR>&nbsp;- CGV에서 진행되는 이벤트 중 VIP선정에 포함되는 이벤트 포인트이며, 특정 이벤트에 한하여 지급되며 지급 일자(24시간 기준)로 누적 적립되며 VIP선정 포인트에 포함됩니다.</P>
<P>■ 그외 포인트 (이벤트 포인트 등)<BR>&nbsp;- 구매 누적 및 VIP선정에 포함되는 이벤트 포인트 외 지급되는 모든 포인트이며, VIP선정 포인트에 포함되지 않습니다</P>
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                            ...
                            <li>
                                <p>
                                    <em>12</em>
                                    <a href="#" class="question">CGV에서 쌓은 CJ ONE 포인트 다 썼는데, CGV VIP가 될 수 있나요? </a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        포인트 사용여부와 관계없이 고객님께서 적립하신 CJ ONE 구매 누적 포인트로만 산정 됩니다
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                            ...
                            <li>
                                <p>
                                    <em>11</em>
                                    <a href="#" class="question">VIP 등급별 유지, 선정 포인트를 알고 싶어요?</a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        <P>VIP 등급별 선정기준은 아래와 같으며 해당 기준은 매 년 변경될 수 있으니 꼭 유의하세요</P>
<P>&nbsp;</P>
<P>
<TABLE style="WIDTH: 451pt; BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=601 border=0>
<COLGROUP>
<COL style="WIDTH: 56pt; mso-width-source: userset; mso-width-alt: 2400" width=75>
<COL style="WIDTH: 119pt; mso-width-source: userset; mso-width-alt: 5088" width=159>
<COL style="WIDTH: 88pt; mso-width-source: userset; mso-width-alt: 3744" width=117>
<COL style="WIDTH: 188pt; mso-width-source: userset; mso-width-alt: 8000" width=250>
<TBODY>
<TR style="HEIGHT: 24pt; mso-height-source: userset" height=32>
<TD class=xl68 style="BORDER-TOP: windowtext 0.5pt solid; HEIGHT: 24pt; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 56pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext 0.5pt solid; BACKGROUND-COLOR: #d8d8d8" height=32 width=75>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">등급명</FONT></STRONG></P></TD>
<TD class=xl68 style="BORDER-TOP: windowtext 0.5pt solid; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 119pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: #d8d8d8" width=159>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">승급 기준</FONT></STRONG></P></TD>
<TD class=xl68 style="BORDER-TOP: windowtext 0.5pt solid; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 88pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: #d8d8d8" width=117>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">등급 유지 포인트</FONT></STRONG></P></TD>
<TD class=xl68 style="BORDER-TOP: windowtext 0.5pt solid; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 188pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: #d8d8d8" width=250>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">추가 승급 조건</FONT></STRONG></P></TD></TR>
<TR style="HEIGHT: 32.25pt; mso-height-source: userset" height=43>
<TD class=xl69 style="BORDER-TOP: windowtext; HEIGHT: 32.25pt; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 56pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext 0.5pt solid; BACKGROUND-COLOR: transparent" height=43 width=75>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">VIP</FONT></STRONG></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 119pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=159>
<P align=center><FONT face="맑은 고딕"><FONT size=2>일반 고객 중 최근 1년 <BR></FONT><FONT size=2>구매 누적 14,000p 이상</FONT></FONT></P></TD>
<TD class=xl71 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 88pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=117>
<P align=center><FONT size=2 face="맑은 고딕">　</FONT></P></TD>
<TD class=xl71 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 188pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=250>
<P align=center><FONT size=2 face="맑은 고딕">　</FONT></P></TD></TR>
<TR style="HEIGHT: 33pt; mso-height-source: userset" height=44>
<TD class=xl69 style="BORDER-TOP: windowtext; HEIGHT: 33pt; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 56pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext 0.5pt solid; BACKGROUND-COLOR: transparent" height=44 width=75>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">RVIP</FONT></STRONG></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 119pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=159>
<P align=center><FONT face="맑은 고딕"><FONT size=2>VIP 승급 후 1년간<BR></FONT><FONT size=2>14,000p 이상 유지</FONT><SPAN style="mso-spacerun: yes"><FONT size=2>&nbsp;</FONT></SPAN></FONT></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 88pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=117>
<P align=center><FONT size=2 face="맑은 고딕">14,000p</FONT></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 188pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=250>
<P align=center><FONT face="맑은 고딕"><FONT size=2>VIP 승급 이후 1년 이내<BR></FONT><FONT size=2>28,000p 달성 시 다음달 즉시 승급</FONT></FONT></P></TD></TR>
<TR style="HEIGHT: 32.25pt; mso-height-source: userset" height=43>
<TD class=xl69 style="BORDER-TOP: windowtext; HEIGHT: 32.25pt; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 56pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext 0.5pt solid; BACKGROUND-COLOR: transparent" height=43 width=75>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">VVIP</FONT></STRONG></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 119pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=159>
<P align=center><FONT size=2 face="맑은 고딕">RVIP 3년 연속 유지</FONT></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 88pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=117>
<P align=center><FONT size=2 face="맑은 고딕">16,000p</FONT></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 188pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=250>
<P align=center><FONT face="맑은 고딕"><FONT size=2>RVIP 승급 이후<BR></FONT><FONT size=2>1년 간 영화 유료관람 횟수 상위 0.1%</FONT></FONT></P></TD></TR>
<TR style="HEIGHT: 29.25pt; mso-height-source: userset" height=39>
<TD class=xl69 style="BORDER-TOP: windowtext; HEIGHT: 29.25pt; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 56pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext 0.5pt solid; BACKGROUND-COLOR: transparent" height=39 width=75>
<P align=center><STRONG><FONT size=2 face="맑은 고딕">SVIP</FONT></STRONG></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 119pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=159>
<P align=center><FONT size=2 face="맑은 고딕">VVIP 5년 연속 유지</FONT></P></TD>
<TD class=xl70 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 88pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=117>
<P align=center><FONT size=2 face="맑은 고딕">20,000p</FONT></P></TD>
<TD class=xl71 style="BORDER-TOP: windowtext; BORDER-RIGHT: windowtext 0.5pt solid; WIDTH: 188pt; BORDER-BOTTOM: windowtext 0.5pt solid; BORDER-LEFT: windowtext; BACKGROUND-COLOR: transparent" width=250>
<P align=center><FONT size=2 face="맑은 고딕">　</FONT></P></TD></TR></TBODY></TABLE></P>
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                            ...
                            <li>
                                <p>
                                    <em>10</em>
                                    <a href="#" class="question">VIP 선정 포인트는 VIP가 되고 나서 유지 되나요?</a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                            ...
                            <li>
                                <p>
                                    <em>9</em>
                                    <a href="#" class="question">일반 고객이 RVIP나 VVIP(SVIP)로 바로 승급될 수 있는 방법은 없나요?</a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        <P>일반 고객님은 최근 1년 누적 포인트 14,000점을 달성하시어 VIP로 먼저 승급하신 이후</P>
<P>순차적으로 높은 등급으로 승급하실 수 있습니다. </P>
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
                            ...
                            <li>
                                <p>
                                    <em>8</em>
                                    <a href="#" class="question">VVIP 조기 승급 기준인 영화 관람 횟수 상위 구매 0.1% 정확한 기준이 어떻게 되나요? </a>
                                </p>
                                <div class="answer">
                                    <strong>답변내용</strong>
                                    <p>
                                        영화 관람 횟수 상위 구매 0.1%는 매해 기준이 달라지므로, 공개하지 않고 있습니다
                                    </p>
                                    <p class="sect-unfold">
                                        <button class="round black"><span>닫기</span></button>
                                    </p>
...
<div class="paging">
  <ul>
    ...
    <li>
      <a href="faq4658.jsp?page=2">2</a>
    </li>
  </ul>
  <button class="btn-paging next" type="button" onclick="location='/user/vip-lounge/faq.aspx?page=2'">다음</button>
  <button class="btn-paging end" type="button" onclick="location='/user/vip-lounge/faq.aspx?page=2'">끝</button>
</div>
...
//<![CDATA[
        ...
        (function ($) {
            $(function () {
                ...
                function Search() {
                    location.href = "/user/vip-lounge/faq.aspx?searchtext=" + escape($("#searchtext").val());
                }
                ...
                $('.sect-unfold button').on('click', function () {
                    $(this).parent().parent('div.answer').hide();
                    return false;
                });
...
<!-- Mirrored from www.cgv.co.kr/user/vip-lounge/faq.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 12:20:42 GMT -->
</html>