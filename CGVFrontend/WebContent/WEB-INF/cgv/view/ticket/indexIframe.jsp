...
<div id="wrap" oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
	...
	<div id="container">
		...
		<div id="ticket" class="ticket ko">
			...
			<div class="steps">
				...
				<div class="step step1" style="height: 595px; display: block;">
					...
					<div class="section section-movie" style="height: 593px;">
						...
						<!-- ☆2 -->
						<input type="hidden" name="s_id" id="s_id" value="${user.s_id}"/>
							...
							<div class="movie-select">
								<div class="tabmenu">
									...
									<div class="tabmenu-selectbox MOVIECOLLAGE" style="display:none;">
										...
										<li com_cd="01"><a href="#" onclick="return false;">큐레이터</a></li><li com_cd="03"><a href="#" onclick="return false;">시네마톡</a></li><li com_cd="04"><a href="#" onclick="return false;">아트톡</a></li><li com_cd="05"><a href="#" onclick="return false;">라이브톡</a></li><li com_cd="85"><a href="#" onclick="return false;">라이브러리톡</a></li><li com_cd="99"><a href="#" onclick="return false;">라이브톡,현장</a></li><li com_cd="c4"><a href="#" onclick="return false;">Special Day</a></li><li com_cd="d7"><a href="#" onclick="return false;">데이빗 린치 특별전</a></li><li com_cd="d8"><a href="#" onclick="return false;">여성인권영화제</a></li><li com_cd="e4"><a href="#" onclick="return false;">데이빗 린치 완전정복</a></li><li com_cd="e5"><a href="#" onclick="return false;">인디애니페스트2017</a></li><li com_cd="e6"><a href="#" onclick="return false;">큐레이터,데이빗 린치 특별전</a></li><li com_cd="M1"><a href="#" onclick="return false;">더스페셜패키지</a></li><li com_cd="R1"><a href="#" onclick="return false;">아트하우스클래스</a></li><li com_cd="Z4"><a href="#" onclick="return false;">명씨네작품전</a></li></ul>
									</div>
									...
									<div class="tabmenu-selectbox SPECIALTHEATER" style="display:none;">
										...
										<li><a href="#" onclick="return false;">SphereX</a></li><li><a href="#" onclick="return false;">TEMPER CINEMA</a></li><li><a href="#" onclick="return false;">ScreenX</a></li></ul>
									</div>
									<span class="side"></span>
								</div>
								<div class="sortmenu">
										...
										<ul class="content scroll-y"
											...
											<c:forEach items="${movieList}" var="movieDto" varStatus="status">
												<li class="rating-${movieDto.rating == '19' ? '18':movieDto.rating == '전체 관람가' ? 'all':movieDto.rating} liMovie"
													...
													<span class="text">${movieDto.title }</span>
													<span class="sreader"></span></a></li>
											</c:forEach>
											
											<!-- 
											<li class="rating-18" data-index="0"
												movie_cd_group="20013728" movie_idx="79949"><a href="#"
												onclick="return false;"><span class="icon">&nbsp;</span><span
													class="text">킹스맨-골든서클</span><span class="sreader"></span></a></li>
											<li class="rating-12" data-index="2"
												movie_cd_group="00100183" movie_idx="39054"><a href="#"
												onclick="return false;"><span class="icon">&nbsp;</span><span
													class="text">인셉션</span><span class="sreader"></span></a></li>
											<li class="rating-15" data-index="3"
												movie_cd_group="20013635" movie_idx="79915"><a href="#"
												onclick="return false;"><span class="icon">&nbsp;</span><span
													class="text">베이비드라이버</span><span class="sreader"></span></a></li>
											<li class="rating-15" data-index="6"
												movie_cd_group="20013396" movie_idx="79847"><a href="#"
												onclick="return false;"><span class="icon">&nbsp;</span><span
													class="text">살인자의기억법</span><span class="sreader"></span></a></li>
											<li class="rating-all" data-index="39"
												movie_cd_group="20009110" movie_idx="78718"><a href="#"
												onclick="return false;"><span class="icon">&nbsp;</span><span
													class="text">시간을달리는소녀</span><span class="sreader"></span></a></li>
											<li class="rating-12" data-index="74"
												movie_cd_group="00050307" movie_idx="12129"><a href="#"
												onclick="return false;"><span class="icon">&nbsp;</span>
												<span class="text">지금만나러갑니다</span>
												<span class="sreader"></span></a></li> 
											-->
							...
							<div class="theater-select">
								...
								<!-- ☆5 -->	
											...
											<c:forEach items="${theaterList }" var="theaterDto" varStatus="status">
												<c:choose>
													<c:when test="${theaterDto.region == '서울' }">
														<script>
															$("#ul_area_0").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '경기' }">
														<script>
															$("#ul_area_1").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '인천' }">
														<script>
															$("#ul_area_2").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '강원' }">
														<script>
															$("#ul_area_3").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '대전' or theaterDto.region == '충청'}">
														<script>
															$("#ul_area_4").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '광주' or theaterDto.region == '전라'}">
														<script>
															$("#ul_area_5").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '대구' or theaterDto.region == '울산' or theaterDto.region == '부산'}">
														<script>
															$("#ul_area_6").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '경상' }">
														<script>
															$("#ul_area_7").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
													<c:when test="${theaterDto.region == '제주' }">
														<script>
															$("#ul_area_8").append('<li class="liBranch" id="theater_code_${theaterDto.theater_code}" data-index="${status.index}" areaindex="0" theater_cd="0056" rating_cd="undefined" style="display: list-item;"><a href="#" onclick="theaterListClickListener(event);return false;">${theaterDto.name}</a></li>');
														</script>
													</c:when>
												</c:choose>
											</c:forEach>	
					...
					<div class="section section-date" style="height: 593px;">
						...
						<div class="col-body" style="height: 560px;">
							...
							<div class="date-list nano has-scrollbar has-scrollbar-y" id="date_list" style="height: 522px;">
								<ul class="content scroll-y" tabindex="-1" style="right: -17px;"><div><li class="month dimmed"><div><span class="year">2017</span><span class="month">9</span><div></div></div></li><li data-index="0" date="20170921" class="day"><a href="#" onclick="return false;"><span class="dayweek">목</span><span class="day">21</span><span class="sreader"></span></a></li><li data-index="1" date="20170922" class="day"><a href="#" onclick="return false;"><span class="dayweek">금</span><span class="day">22</span><span class="sreader"></span></a></li><li data-index="2" date="20170923" class="day day-sat"><a href="#" onclick="return false;"><span class="dayweek">토</span><span class="day">23</span><span class="sreader"></span></a></li><li data-index="3" date="20170924" class="day day-sun"><a href="#" onclick="return false;"><span class="dayweek">일</span><span class="day">24</span><span class="sreader"></span></a></li><li data-index="4" date="20170925" class="day"><a href="#" onclick="return false;"><span class="dayweek">월</span><span class="day">25</span><span class="sreader"></span></a></li><li data-index="5" date="20170926" class="day"><a href="#" onclick="return false;"><span class="dayweek">화</span><span class="day">26</span><span class="sreader"></span></a></li><li data-index="6" date="20170927" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">27</span><span class="sreader"></span></a></li><li data-index="7" date="20170928" class="day"><a href="#" onclick="return false;"><span class="dayweek">목</span><span class="day">28</span><span class="sreader"></span></a></li><li data-index="8" date="20170929" class="day"><a href="#" onclick="return false;"><span class="dayweek">금</span><span class="day">29</span><span class="sreader"></span></a></li><li data-index="9" date="20170930" class="day day-sat"><a href="#" onclick="return false;"><span class="dayweek">토</span><span class="day">30</span><span class="sreader"></span></a></li><li class="month dimmed"><div><span class="year">2017</span><span class="month">10</span><div></div></div></li><li data-index="10" date="20171001" class="day day-sun"><a href="#" onclick="return false;"><span class="dayweek">일</span><span class="day">1</span><span class="sreader"></span></a></li><li data-index="11" date="20171002" class="day"><a href="#" onclick="return false;"><span class="dayweek">월</span><span class="day">2</span><span class="sreader"></span></a></li><li data-index="12" date="20171003" class="day"><a href="#" onclick="return false;"><span class="dayweek">화</span><span class="day">3</span><span class="sreader"></span></a></li><li data-index="13" date="20171004" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">4</span><span class="sreader"></span></a></li><li data-index="14" date="20171009" class="day"><a href="#" onclick="return false;"><span class="dayweek">월</span><span class="day">9</span><span class="sreader"></span></a></li><li data-index="15" date="20171010" class="day"><a href="#" onclick="return false;"><span class="dayweek">화</span><span class="day">10</span><span class="sreader"></span></a></li><li data-index="16" date="20171016" class="day"><a href="#" onclick="return false;"><span class="dayweek">월</span><span class="day">16</span><span class="sreader"></span></a></li><li data-index="17" date="20171018" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">18</span><span class="sreader"></span></a></li><li data-index="18" date="20171019" class="day"><a href="#" onclick="return false;"><span class="dayweek">목</span><span class="day">19</span><span class="sreader"></span></a></li><li class="month dimmed"><div><span class="year">2017</span><span class="month">11</span><div></div></div></li><li data-index="19" date="20171115" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">15</span><span class="sreader"></span></a></li></div></ul>
							<div class="pane pane-y" style="display: block; opacity: 1; visibility: visible;"><div class="slider slider-y" style="height: 50px; top: 0px;"></div></div><div class="pane pane-x" style="display: none; opacity: 1; visibility: visible;"><div class="slider slider-x" style="width: 50px;"></div></div></div>
						</div>
					</div>
					<!-- TIME 섹션 -->
			...
			<!-- 배너 -->
			<div class="banner" id="ticket_bottom_banner" style="padding-top: 0px;"><a target="_blank" title="새창" href="http://ad.cgv.co.kr/click/CGV/CGV_201401/RIA@B_ticketing?ads_id=28514&amp;creative_id=35646&amp;click_id=46906&amp;event=" style="background-color: rgb(255, 255, 255);"><span style="sreader">踰二??</span><img src="http://adimg.cgv.co.kr/images/201709/CrimeCity/0914_996x140.jpg" alt="踰二??" onload="ticketNeedResize();" style="width:996px;height:140px"></a></div>
			<!-- //배너 -->
			<!-- 팝업 -->
			<div class="popups">                
				<!-- Popup - 로그인 --> 
...
<!-- //Popup -->
	...
	<!-- <div id="ticket_banner" class="ticket_banner" style="height: 669px;">
		<div><div class="AdvertiseCon" id="RIA_Skin_Ticketing_L" style="width: 160px; height: 300px; background: none; position: absolute; top: 75px; left: -164px; overflow: hidden;"><a href="http://ad.cgv.co.kr/click/CGV/CGV_201608/RIA@RIA_Skin_Ticketing?ads_id=27951&amp;creative_id=29457&amp;click_id=38318&amp;event=" target="_blank" style="top: 0px;"><img src="http://adimg.cgv.co.kr/images/201612/payco/160x300_ria.jpg" width="160" height="300" border="0" alt="광고-페이코" style="width: 160px; height: 300px;"></a></div><div class="AdvertiseCon" id="RIA_Skin_Ticketing_R" style="width: 160px; height: 300px; background: none; position: absolute; top: 75px; left: 1000px; overflow: hidden;"><a href="http://ad.cgv.co.kr/click/CGV/CGV_201608/RIA@RIA_Skin_Ticketing?ads_id=27951&amp;creative_id=29457&amp;click_id=38318&amp;event=" target="_blank" style="top: 0px;"><img src="http://adimg.cgv.co.kr/images/201612/payco/160x300_ria.jpg" width="160" height="300" border="0" alt="광고-페이코" style="width: 160px; height: 300px;"></a></div></div>
	</div> -->
	<!-- banner -->
</div>
