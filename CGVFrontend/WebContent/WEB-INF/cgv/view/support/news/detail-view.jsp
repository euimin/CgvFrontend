...
<script>location.replace('../../err3bc8-2.jsp?idx=6801&amp;page=1&amp;type=&amp;searchtext=&amp;searchfield=0&amp;pb=Y');</script>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko">

<!-- Mirrored from www.cgv.co.kr/support/news/detail-view.aspx?idx=6801&type=&page=1&searchtext=&searchfield=0 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 20:20:17 GMT -->
...
<link rel="stylesheet" media="all" type="text/css" href="../../img/R2014/css/customer.css" />
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=MbYHx94WzxtXgFmQW%2fekU%2bk3VAa47vq5y4oHA%2fQNB9dSP9UJ4TZrzp7cAMzC8gFCrZcGwXmw%2bZbvFVJSwK4XenBlYXVJZ09JWTFING43ZFZFQ2pyczlUTzl4TjZBZmJNR0ViS2pSNjRzWUk5dzAwN2ZHREtoQnlOdFVIQjJJNTc%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/support/news/detail-view.aspx?idx=6801&type=&page=1&searchtext=&searchfield=0" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../user/login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fsupport%2fnews%2fdetail-view.aspx%3fidx%3d6801%26type%3d%26page%3d1%26searchtext%3d%26searchfield%3d0" class="login" ><span>로그인</span></a></li>
		...
		<div class="col-detail">
			...
			<div class="board_view_area">
				<ul class="top_title_faq">
					<li class="title">[] </li>
					<li class="stit_area">
						<span>등록일<em class="regist_day">0001.01.01</em></span>
						<span class="check_tit_area">조회수<em class="check_num">0</em></span>
					</li>
				</ul>
				<div class="view_area">
					<p></p>
...
//<![CDATA[
    ...
    (function ($) {
        $(function () {
            ...
            function Search() {
                location.href = "/support/news/default.aspx?searchtext=" + escape("") + "&page=1&type=&searchfield=0";
                return false;
            }
        });
    })(jQuery);
