...
<script type='text/javascript'>location.replace('../../err3bc8.jsp?idx=36&amp;type=244&amp;page=1&amp;searchtext=&amp;pb=Y');</script>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko">

<!-- Mirrored from www.cgv.co.kr/support/faq/detail-view.aspx?idx=36&type=244&searchtext=&page=1 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 17:01:49 GMT -->
...
<link rel="stylesheet" media="all" type="text/css" href="../../img/R2014/css/customer.css" />
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=WEoF3EFVsYeM1G7IULlNBONIA9HrsVgkwvfdWUVCvjN55eI8AV%2brrMDQBis8Vb8h6%2bi8Rd97vfaesjlaSfqcSXExamhPekpLVW9rcnJhOVlvSG5zWDFvQ05SNjNRcHJoR0VXNUhYbXovbW16cTI2dkJIckZBVWZ4aFBOeSszWjk%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/support/faq/detail-view.aspx?idx=36&type=244&searchtext=&page=1" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../user/login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fsupport%2ffaq%2fdetail-view.aspx%3fidx%3d36%26type%3d244%26searchtext%3d%26page%3d1" class="login" ><span>로그인</span></a></li>
...
//<![CDATA[
    ...
    (function ($) {
        $(function () {
            ...
            function Search() {
                location.href = "/support/faq/default.aspx?searchtext=" + escape("") + "&page=1" + "&type=244";
                return false;
            }
        });
    })(jQuery);
