...
<head>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=UlNvPM0Ar3S6WWnuCG2y4pvzLhYC%2fvMmJfQekQk8GgSW%2beuxfMnFfLy8AhGaB7miUNFArxhkwpFj2%2fr31%2f7VJGZPNDFjMVkzMnV5aGR2Z2RTaDM3Q1Z3MGVtRzg1TjAzRVpYQTZBcllxTnBxOTdPNDlsQlgxNXd5TVY2MDhpcEE%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/movies/default.aspx?lt=1&ft=0" />
    </form>
    <script type="text/javascript">
        function cjsso() {
                ...
                <div class="sect-bcrumb">
                    <ul>
                        <li><a href="/CGVFrontend"><img alt="home" src="http://img.cgv.co.kr/R2014/images/common/btn/btn_home.png" /></a></li>
                            ...
                            <li >
                                <a href="<c:url value='/movie.front'/>">무비차트</a>
                            </li>
                ...
                <li>
                    <div class="box-image" >
                    	<c:if test="${status.count le 8}">
                        	<strong class="rank">No.${status.count}</strong>	
                        </c:if>
                        <a href="<c:url value='/movieDetail.front?movie_code=${movie.movie_code}'/>">
...
//]]>
    ...
    <!-- Aside Banner :  -->
	<%@include file="/WEB-INF/cgv/template/asideBanner.jsp"%>
	<!-- //Aside Banner -->
