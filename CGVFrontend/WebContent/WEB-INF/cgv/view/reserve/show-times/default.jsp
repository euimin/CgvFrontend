...
<!-- Mirrored from www.cgv.co.kr/reserve/show-times/default.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 15:01:20 GMT -->
...
<head>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=WEoF3EFVsYeM1G7IULlNBONIA9HrsVgkwvfdWUVCvjN55eI8AV%2brrMDQBis8Vb8h6%2bi8Rd97vfaesjlaSfqcSXExamhPekpLVW9rcnJhOVlvSG5zWHl6Sld5TEljNVgyR1R3SHkwL0txWldJTkRrNmNjUm41WDNKSU53TG9HWEg%3d"></script>
</head>
<body class="">
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../user/login/index.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2freserve%2fshow-times%2fdefault.aspx" class="login" ><span>로그인</span></a></li>
            ...
            <div class="im-wrap"> <!-- Important wrap -->
				<h2><img src="../../img/R2014/images/title/h2_showtimes.png" alt="SHOWTIMES" /></h2>
                ...
                <div class="sect-bcrumb">
                    <ul>
                        <li><a href="../../index.jsp"><img alt="home" src="../../img/R2014/images/common/btn/btn_home.png" /></a></li>
                            ...
                            <li >
                                <a href="../../ticket/index.jsp">예매</a>
                            </li>
                        
                            <li >
                                <a href="index.jsp">상영시간표</a>
                            </li>
...
<div class="sect-common"> 
    ...
    <div class="favorite-wrap">
        <ul class="tab-menu">
            <li class="on"><a href="../../index.jsp" onclick="return false;" title="현재 선택">극장별 상영시간표</a></li>
            <li class="last"><a href="movies.jsp">영화별 상영시간표</a></li>
        </ul>
...
<div class="cols-content">
    ...
    <div class="col-detail"> 
        ...
        <!-- Showtimes Start -->
        <iframe id="ifrm_movie_time_table" src="../../common/showtimes/iframeTheaterab9d.jsp?areacode=01&amp;theatercode=0056&amp;date=20170710" title="CGV강남 상영시간표" width="100%" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
        <!-- /Showtimes End --> 
    </div>
    <div class="col-aside">
