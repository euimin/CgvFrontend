...
<!-- Mirrored from www.cgv.co.kr/theaters/special/parking.aspx?regioncode=SDX&theatercode=0107 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 20:31:17 GMT -->
...
<head>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=MbYHx94WzxtXgFmQW%2fekU%2bk3VAa47vq5y4oHA%2fQNB9dSP9UJ4TZrzp7cAMzC8gFCrZcGwXmw%2bZbvFVJSwK4XenBlYXVJZ09JWTFING43ZFZFQ2pyczlzNUZjajhDbnVkaFkvOE05M05kdFJmTE9qcWxXRkFrSHFnYy9sbi9qU0o%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/theaters/special/parking.aspx?regioncode=SDX&theatercode=0107" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../user/login/index1a61.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2ftheaters%2fspecial%2fparking.aspx%3fregioncode%3dSDX%26theatercode%3d0107" class="login" ><span>로그인</span></a></li>
        ...
        <div class="slider" id="specialtheater">
            <div class="item-wrap">
                ...
                <div class="item">
                        ...
                        <a class="imax" href="parking88a2.jsp?regioncode=07"  >IMAX</a>
                        ...
                        <a class="soundX on" href="parkingca49.jsp?regioncode=SDX" title='현재 선택됨' >SOUNDX</a>
    ...
    <div class="wrap-special-schedule">
        <div class="wrap-theaterlist">
            ...
            <ul>
                        ...
                        <li ><a href="parking263c.jsp?regioncode=SDX&amp;theatercode=0112" >SoundX 여의도</a></li>
                    
                        <li ><a href="parkingbf41.jsp?regioncode=SDX&amp;theatercode=0059" >SoundX 영등포</a></li>
                    
                        <li ><a href="parking1f2c.jsp?regioncode=SDX&amp;theatercode=0205" >SoundX 이천</a></li>
                    
                        <li class='on'><a href="parking00d4.jsp?regioncode=SDX&amp;theatercode=0107" title='현재 선택됨'>SoundX 청담씨네시티</a></li>
