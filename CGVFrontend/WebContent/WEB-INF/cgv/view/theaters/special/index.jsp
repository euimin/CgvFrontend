...
<!-- Mirrored from www.cgv.co.kr/theaters/special/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 11:56:32 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="4DX란? &lt; 4DX | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">4DX란? &lt; 4DX | 영화 그 이상의 감동. CGV</title>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=MbYHx94WzxtXgFmQW%2fekU%2bk3VAa47vq5y4oHA%2fQNB9dSP9UJ4TZrzp7cAMzC8gFCrZcGwXmw%2bZbvFVJSwK4XenBlYXVJZ09JWTFING43ZFZFQ2pycy9id0JYblJPUDZrbkZtdmdmdGljdjRJTjZLcmpONTlKK1hwTXBwaXZjMmw%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/theaters/special/default.aspx" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../user/login/index0701.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2ftheaters%2fspecial%2fDefault.aspx" class="login" ><span>로그인</span></a></li>
...
<div class="wrap-specialtheater">
        ...
        <div class="slider" id="specialtheater">
            <div class="item-wrap">
                ...
                <div class="item">
                        ...
                        <a class="forDX on" href="indexe9c4.jsp?regioncode=4D14" title='현재 선택됨'>4DX</a>
                    
                        <a class="imax" href="index88a2.jsp?regioncode=07" >IMAX</a>
                    
                        <a class="screenX" href="index6b39.jsp?regioncode=SCX" >SCREENX</a>
                    
                        <a class="sphereX" href="indexb1bf.jsp?regioncode=SPX" >SphereX</a>
                    
                        <a class="soundX" href="indexca49.jsp?regioncode=SDX" >SOUNDX</a>
                    
                        <a class="starium" href="indexb462.jsp?regioncode=110" >STARIUM</a>
                    
                        <a class="veatbox" href="index06d4.jsp?regioncode=VB" >VEATBOX</a>
                    
                        <a class="tempurcinema" href="indexbf2c.jsp?regioncode=TEM" >TEMPUR CINEMA</a>
                    
                        <a class="gold" href="index3c59.jsp?regioncode=99" >GOLD CLASS</a>
                    
                        <a class="cine" href="indexe851.jsp?regioncode=103" >CINE de CHEF</a>
                    
                        <a class="private" href="index61d5.jsp?regioncode=pc" >THE PRIVATE CINEMA</a>
                    
                        <a class="kids" href="index2780.jsp?regioncode=CK" >CINE KIDS</a>
                    
                        <a class="premium" href="index2bc8.jsp?regioncode=PRM" >PREMIUM</a>
                    
                        <a class="sweetbox" href="index4dc9.jsp?regioncode=09" >SWEETBOX</a>
    ...
    <div class="tit-heading-wrap" style="border-bottom: 0px;">
        <h3>4DX</h3>
        <div class="submenu">
  
            <ul>
                
                    <li class='on'><a href="defaulte9c4.jsp?regioncode=4D14">4DX란?</a></li>
                
                    <li ><a href="show-times0e41.jsp?regioncode=4D14&amp;theatercode=0107">상영시간표</a></li>
                
            </ul>
        </div>
    </div>
                
    <div class="box-visual" style="border-bottom: 0px;">
        <div style="background-color:Black; height: 550px;">
            <iframe id="ifrm_hdtrailer_best" src="../../common/player/index3b92.jsp?path=http%3a%2f%2fh.vod.cgv.co.kr%3a80%2fvodCGVa%2f77914%2f77914_122402_1200_128_960_540.mp4&amp;poster=http%3a%2f%2fimg.cgv.co.kr%2fTheater%2fTheater%2f2014%2f1030%2f4dx_st_img.png" title="what 동영상" style="width:980px;height:551px;" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
        </div>
    </div>
    
    <!-- 개발 공통 끝 -->
    
    <!-- Html load Text Binding Start -->
    <div class="sect-contents">
    <img src="../../img/R2014/images/sub/specialtheater/fordx/img_4dx_08.jpg" alt="I’m in the movie - 4DX 상영관은 영화의 장면에 맞추어 움직이는 모션 시트와 더불어 바람, 빛, 안개, 향기, 진동 등의 다양한 환경 효과를 느낄 수 있는 오감체험 특별 상영관입니다. 단순한 영화 관람을 넘어 관객들은 영화 속 주인공이 된 듯한 체험을 할 수 있으며, 장면마다 생생함을 극대화 시키는 4DX효과를 통해 영화에 더욱 몰입할 수 있습니다." />
    <div class="wrap-fordxeffects">
        <ul>
            <li class="wind on">
                <a href="#">Wind effects</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/wind_11.jpg" alt="Wind effects" /></div>
            </li>
            <li class="bubbles">
                <a href="#">Bubbles</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/bubble_08.jpg" alt="Bubbles" /></div>
            </li>
            <li class="lights">
                <a href="#">strobe lights</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/lighting_11.jpg" alt="strobe lights" /></div>
            </li>
            <li class="fog">
                <a href="#">fog</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/fog_08.jpg" alt="fog" /></div>
            </li>
            <li class="vibration">
                <a href="#">Vibration</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/vibration_11.jpg" alt="Vibration" /></div>
            </li>
            <li class="scent">
                <a href="#">scent</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/scent_11.jpg" alt="scent" /></div>
            </li>
            <li class="facewater">
                <a href="#">Face Water</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/water_11.jpg" alt="Face Water" /></div>
            </li>
            <li class="shatpair">
                <a href="#">Short bursts of shatp air</a>
                <div><img src="../../img/R2014/images/sub/specialtheater/fordx/air_11.jpg" alt="Short bursts of shatp air" /></div>
            </li>
        </ul>
    </div>
    <img src="../../img/R2014/images/sub/specialtheater/fordx/fordx_02.jpg" alt="Motion Seat - 관람석이 상하로, 좌우로, 앞뒤로 움직이며 현장감을 극대화 합니다." />
</div><!-- .sect-contents -->

<!-- Line Up 4DX, IMAX 그 외 No -->
<iframe id="ifrm_movie_lineup" src="theater-line-upe9c4.jsp?regioncode=4D14" title="LINE UP" width="100%" height="560" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
...
//<![CDATA[
    (function ($) {
        $(function () {
            ...
            //document.iFrame = $('#ifrm_movie_lineup').sameHeightFrame();

			var $tabMenu = $('.wrap-fordxeffects > ul > li > a'),
				$tabMenuContent = $('.effects > img');
				$wrapOffsetLeft = $('.wrap-fordxeffects').offset().left;
				$wrapOffsetTop = $('.wrap-fordxeffects').offset().top;
			function offsetSetting(){
				var $wrap = $('.wrap-fordxeffects');
				$wrap.find('div').each(function() {
					var itemoffsetLeft = $(this).offset().left,
						itemoffsetTop = $(this).offset().top;			
					$(this).css({
						'left': ($wrapOffsetLeft - itemoffsetLeft),
						'top': ($wrapOffsetTop - itemoffsetTop)
					});					                    
                });				
			};						
			function cinerent(){				
				$($tabMenu).click(function(){					
					$(this).parent('li').removeClass('off').addClass('on').siblings().removeClass('on').addClass('off');
					return false;
				})
			};			
			offsetSetting();
			$($tabMenu).parent('li').addClass('off');
			cinerent();
        });
    })(jQuery);
//]]>
...
(function ($) {
    $(function () {
    	 // ie7 z-index 처리가 까다로워 다르게 처리
		 $('.wrap-fordxeffects > ul > li > div').hide();
         $('.wrap-fordxeffects > ul > li > a').on('click', function(){
         	var i = $('.wrap-fordxeffects > ul > li').index($(this).parent('li'));         
         	$(this).parents('ul').attr('data-listIndex', i + 1 );
         })
	 });
})(jQuery);
//]]>
...
<![endif]-->
    ...
    <!-- Html load Text Binding End -->

     
        

    <div class="cols-specialtheater">
    
              <div class="col-specialtimetable forDX">
     
          
            <h4>상영시간표</h4>
            <a href="show-times0e41.jsp?regioncode=4D14&amp;theatercode=0107">상영시간표 더보기</a>
            <p><strong>4DX</strong> 에서 상영중인 상영시간표로 한눈에 바로 예매가 가능합니다.</p>
            
        </div>

        <div class="col-specialclub">
            <h4>특별관 Club</h4>
            <p>영화도, 혜택도 특별함을 원하는 당신을 위해 !</p>
            <a href="../../user/memberShip/ClubService.jsp" title="특별관 Club 가입하기">특별관 Club 가입하기</a>
        </div>
    </div>
   ...
   <!-- <div class="sect-sns">
      <ul>                	
        ...
        <div class="share">
            ...
            <div class="fb-like" style="z-index:2" data-href="http%3a%2f%2fwww.cgv.co.kr%2ftheaters%2fspecial%2fDefault.aspx" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
        </div>
    
    </div>-->
</div><!-- .wrap-specialtheater -->
<!-- 실컨텐츠 끝 -->
<script type="text/javascript">
//<![CDATA[
    (function ($) {
        $(function () {
            ...
            //특별관 >
            // $('.col-specialclub a').on('click', function () {
            //     openSpecialClub();
            //     return false;
            // });
    ...
    function popup() {
        alert("본 상영시간표에서는 TEMPUR CINEMA와 CINE de CHEF의 상영시간표를 모두 확인할 수 있습니다.\n상영관 정보를 꼭 확인해주세요.");
        document.location.href = "show-times8a71.jsp?regioncode=103&amp;theatercode=0040";
        return false;

//        if (confirm("TEMPUR CINEMA는 CINE de CHEF 특별관 페이지에서 확인하실 수 있습니다.\n\n이동하시겠습니까?")) 
//        {
//            document.location.href = "http://www.cgv.co.kr/theaters/special/show-times.aspx?regioncode=103&theatercode=0040";
//            return false;
//        }
//        else {
//            return false;
...
<!-- Mirrored from www.cgv.co.kr/theaters/special/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 11:57:35 GMT -->
</html>