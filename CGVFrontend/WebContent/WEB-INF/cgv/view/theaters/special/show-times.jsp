...
<!-- Mirrored from www.cgv.co.kr/theaters/special/show-times.aspx?regioncode=SDX&theatercode=0107 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2017 15:36:58 GMT -->
...
<head>
    ...
    <meta id="ctl00_og_title" property="og:title" content="상영시간표 &lt; SOUNDX | 영화 그 이상의 감동. CGV"></meta>
    ...
    <title id="ctl00_headerTitle">상영시간표 &lt; SOUNDX | 영화 그 이상의 감동. CGV</title>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=h%2fWbTq57CullxPvpQNMR5dE2jwVLqlq6twsxR%2bYN2xcaJCdMuo8QClcMAxKlp4bEY%2bVxer3J9U3YhmiNOrck%2fDRWS3Y1YStnZnhYU2pzTkxqcHNyQ3paZ3ZMTU1yaXZOdEZLMDZvWllJOU5vTUNwSFZpdzZIS01XU1RaYkdTWHQ%3d"></script>
</head>
<body class="">

    <form name="ssologinfrm" action="https://www.cgv.co.kr/user/login/login-sso.aspx" method="post">
        <input type="hidden" id="cjssoq" name="cjssoq" />
        <input type="hidden" name="returnURL" value="/theaters/special/show-times.aspx?regioncode=SDX&theatercode=0107" />
    </form>
    <script type="text/javascript">
        function cjsso() {
		...
		<div class="head">
			...
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="../../user/login/indexd57f.jsp?returnURL=http%3a%2f%2fwww.cgv.co.kr%2ftheaters%2fspecial%2fshow-times.aspx%3fregioncode%3dSDX%26theatercode%3d0107" class="login" ><span>로그인</span></a></li>
                ...
                <div class="sect-bcrumb">
                    <ul>
                        <li><a href="../../index.jsp"><img alt="home" src="../../img/R2014/images/common/btn/btn_home.png" /></a></li>
                            ...
                            <li >
                                <a href="index.jsp">특별관</a>
                            </li>
                        
                            <li >
                                <a href="indexca49.jsp?regioncode=SDX">SOUNDX</a>
                            </li>
        ...
        <div class="slider" id="specialtheater">
            <div class="item-wrap">
                ...
                <div class="item">
                        ...
                        <a class="forDX" href="show-timese9c4.jsp?regioncode=4D14"  >4DX</a>
                    
                        <a class="imax" href="show-times88a2.jsp?regioncode=07"  >IMAX</a>
                    
                        <a class="screenX" href="show-times6b39.jsp?regioncode=SCX"  >SCREENX</a>
                    
                        <a class="sphereX" href="show-timesb1bf.jsp?regioncode=SPX"  >SphereX</a>
                    
                        <a class="soundX on" href="show-timesca49.jsp?regioncode=SDX" title='현재 선택됨' >SOUNDX</a>
                    
                        <a class="starium" href="show-timesb462.jsp?regioncode=110"  >STARIUM</a>
                    
                        <a class="veatbox" href="show-times06d4.jsp?regioncode=VB"  >VEATBOX</a>
                    
                        <a class="tempurcinema" href="show-timesbf2c.jsp?regioncode=TEM"  >TEMPUR CINEMA</a>
                    
                        <a class="gold" href="show-times3c59.jsp?regioncode=99"  >GOLD CLASS</a>
                    
                        <a class="cine" href="show-timese851.jsp?regioncode=103"  >CINE de CHEF</a>
                    
                        <a class="private" href="show-times61d5.jsp?regioncode=pc"  >THE PRIVATE CINEMA</a>
                    
                        <a class="kids" href="show-times2780.jsp?regioncode=CK"  >CINE KIDS</a>
                    
                        <a class="premium" href="show-times2bc8.jsp?regioncode=PRM"  >PREMIUM</a>
                    
                        <a class="sweetbox" href="show-times4dc9.jsp?regioncode=09"  >SWEETBOX</a>
    ...
    <div class="tit-heading-wrap">
        ...
        <div class="submenu">
            <ul>
                    ...
                    <li >
                        <a href="defaultca49.jsp?regioncode=SDX" >
                            SOUNDX란?
                        </a>
                    </li>
                
                    <li class='on'>
                        <a href="show-timesbf41.jsp?regioncode=SDX&amp;theatercode=0059" title='현재 선택됨'>
                            상영시간표
                        </a>
                    </li>
    ...
    <div class="wrap-special-schedule">
        <div class="wrap-theaterlist">
            ...
            <ul>
                        ...
                        <li ><a href="show-times263c.jsp?regioncode=SDX&amp;theatercode=0112" >SoundX 여의도</a></li>
                    
                        <li ><a href="show-timesbf41.jsp?regioncode=SDX&amp;theatercode=0059" >SoundX 영등포</a></li>
                    
                        <li ><a href="show-times1f2c.jsp?regioncode=SDX&amp;theatercode=0205" >SoundX 이천</a></li>
                    
                        <li class='on'><a href="show-times00d4.jsp?regioncode=SDX&amp;theatercode=0107" title='현재 선택됨'>SoundX 청담씨네시티</a></li>
                    
            </ul>
        </div>
        <div class="cols-content">
            <h4 class="tit-showtime">SoundX 청담씨네시티</h4>  

                
                    <p class="txt-theaterinfo">서울특별시 강남구 신사동 651-21<br>서울특별시 강남구 도산대로 323  (신사동) T.1544-1122 <a href="../indexb25a.jsp?page=location&amp;theaterCode=0107#menu">위치/주차 안내  &gt;</a></p>
            ...
            <div class="noti-theater">
                ...
                <ul>
                        ...
                        <li><a href="http://section.cgv.co.kr/support/news/view.aspx?idx=7007" target="_blank" title="새창 열림">OK캐쉬백 시스템 점검 (6/20 23:30 ~ 6/21 07:30)</a><span>2017-06-15</span></li>
                    
                        <li><a href="http://section.cgv.co.kr/support/news/view.aspx?idx=6997" target="_blank" title="새창 열림">YES쿠폰 사용불가 안내 (6/14, 00시 ~ 07시) </a><span>2017-06-08</span></li>
                    
                        <li><a href="http://section.cgv.co.kr/support/news/view.aspx?idx=6978" target="_blank" title="새창 열림">[공지] 우리은행 위비꿀머니 점검시간 안내</a><span>2017-04-27</span></li>
                    
                </ul>
                <a class="link-more" href="http://section.cgv.co.kr/support/news/Default.aspx?TheaterCode=0107&amp;Category=2" target="_blank" title="새창 열림">공지사항 더보기</a>
            </div>

            <div class="col-detail">
            	<div class="descri-info theater">
                    <ul>
                        <li><a id="view_price3" class="priceinfo" style="cursor:pointer;" target="_blank" title="새창">관람가격 안내</a></li>
                ...
                <div class="sect-eventlist theater">
                    ...
                    <ul>
                                ...
                                <li>
                                    <div class="box-image">
                                        <a href="../../culture-event/event/detail-viewfc27.jsp?idx=16375">
                                            <span class="thumb-image">
                                                <img src="../../../img.cgv.co.kr/Event/Event/2017/0628/1706_100_wlist.jpg" alt="CGV극장별[CGV청담씨네시티]서브팩관 1주년 프로모션" />
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="../../culture-event/event/detail-viewfc27.jsp?idx=16375"><em class="text-rightblue">CGV극장별</em><strong>[CGV청담씨네시티]서브팩관 1주년 프로모션</strong></a>
                                        <p></p>
                                        <em class="date"><span>기간: </span>2017.07.03 ~ 2017.07.31</em>
                                    </div>
                                </li>
                            
                                <li>
                                    <div class="box-image">
                                        <a href="../../culture-event/event/detail-view166b.jsp?idx=15601">
                                            <span class="thumb-image">
                                                <img src="../../../img.cgv.co.kr/Event/Event/2017/0215/%5bCGV_1702_050%5dwlist.jpg" alt="CGV극장별[CGV청담씨네시티] SUBPAC TIME FESTA" />
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="../../culture-event/event/detail-view166b.jsp?idx=15601"><em class="text-rightblue">CGV극장별</em><strong>[CGV청담씨네시티] SUBPAC TIME FESTA</strong></a>
                                        <p></p>
                                        <em class="date"><span>기간: </span>2017.02.15 ~ 2017.12.31</em>
                                    </div>
                                </li>
                            
                                <li>
                                    <div class="box-image">
                                        <a href="../../culture-event/event/detail-view0684.jsp?idx=16343">
                                            <span class="thumb-image">
                                                <img src="../../../img.cgv.co.kr/Event/Event/2017/0621/1706_074_240_200.jpg" alt="스페셜이벤트ITS NEW Revolution" />
                                            </span>
                                        </a>
                                    </div>
                                    <div class="box-contents">
                                        <a href="../../culture-event/event/detail-view0684.jsp?idx=16343"><em class="text-rightblue">스페셜이벤트</em><strong>ITS NEW Revolution</strong></a>
                                        <p></p>
                                        <em class="date"><span>기간: </span>2017.06.19 ~ 2017.07.01</em>
                                    </div>
                                </li>
...
<!-- ScreenX 관람 가격 안내/ 등급 안내 -->
<script type="text/template" id="temp_priceinfo2">
...
function fnPricePage() {
    var strTheaterCode = "0107";
    var strRegionCode = "SDX";

    //var strSpecialTheater = "IMAX";

    if (strRegionCode == "4D14") {
        //alert("gggg");
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=4DX';
    }
    else if (strRegionCode == "07") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=IMAX';
    }
    else if (strRegionCode == "99") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=GOLDCLASS';
    }
    else if (strRegionCode == "SCX") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=SCREENX';
    }
    else if (strRegionCode == "SPX") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=SPHEREX';
    }
    else if (strRegionCode == "110") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=STARIUM';
    }
    else if (strRegionCode == "103") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=CINEDECHEF';
    }
    else if (strRegionCode == "CK") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=CINEKIDS';
    }
    else if (strRegionCode == "PRM") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=PREMIUM';
    }
    else if (strRegionCode == "09") {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=SWEETBOX';
    }
    else {
        location.href = '/theaters/theaterPrice.aspx?tc=' + strTheaterCode + '&spe=IMAX';
    }
    ...
    (function ($) {
        ...
        $('#view_price2').on('click', function () {
            ...
            var $std = $(this),
				options = {
				    '$target': $std,
				    'html': $("#temp_priceinfo2").jsp(),
				    'position': 'absolute',
				    'mask': 'none'
				};

            //$('#priceinfo_online').jsp($("#ifrm_movie_time_table").contents().find("#temp_priceinfo_online").jsp());
            ...
            $('#wrap_theater_price .tab-menu-round li').on('click', function () {
                ...
                if ($this.data('screen-type') == 'cgv')
                    $('#priceinfo_online').show();
                else
                    $('#priceinfo_online').hide();
