...
<head>
    ...
    <script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=FwoXmxvITgqzikLxdZzGdfWLz3u9M9ruto1YHgewsXBTOjzF314YQ%2fzUZErngLbUDVDULlCwXF7U5GMe4XUPsHlEcE5YYTNUaDd3b0FpWUwzVFl4cldEWWxvWFB0VGwyVkVjQVc5K1V2Q2d6M2QxeDBRWnF4am5ESU9rOG1EYTI%3d"></script>
</head>
<body class="">
...
<div class="wrap-theater">
    <h3><img src="http://img.cgv.co.kr/R2014/images/title/h3_theater.gif" alt="THEATER" /></h3>
            ...
            <div class="box-contents">
                <div class="theater-info">
                    ...
                    <span class="screentype">
                            ...
                            <a href='/theaters/special/?regioncode=09&theaterCode=0056' class='sweetbox'>SWEETBOX</a>
                ...
                <div class="noti-theater">
                    ...
                    <ul>
                            ...
                            <li><a href="http://section.cgv.co.kr/support/news/view.aspx?Idx=7084" target="_blank" title="새창 열림">NH농협카드 시스템 점검 件</a></li>
                        
                            <li><a href="http://section.cgv.co.kr/support/news/view.aspx?Idx=7071" target="_blank" title="새창 열림">아시아나 마일리지 시스템 점검으로 인한 사용불가 안내</a></li>
    ...
    <ul class="tab-menu" id="menu">
        <li class='on'><a href="./?areacode=01&theaterCode=0056&date=20170919#menu" title='현재 선택됨'>상영시간표</a></li>
...
<!-- Showtimes Start -->
<iframe id="ifrm_movie_time_table" src="http://www.cgv.co.kr/common/showtimes/iframeTheater.aspx?areacode=01&theatercode=0056&date=20170919" title="[] 상영시간표" width="100%" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
<!-- /Showtimes End -->
...
<div class="sect-eventlist theater">
    ...
    <ul>
                ...
                <li>
                    <div class="box-image">
                        <a href="../../culture-event/event/detail-view.aspx?idx=16756">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Event/Event/2017/0913/pc.jpg" alt="CGV극장별+지금 현대백화점카드 신청하면 CGV영화예매권 1매 쏜다!" />
                            </span>
                        </a>
                    </div>
                    <div class="box-contents">
                        <a href="../../culture-event/event/detail-view.aspx?idx=16756"><em class="text-rightblue">CGV극장별</em><strong>지금 현대백화점카드 신청하면 CGV영화예매권 1매 쏜다!</strong></a>
                        <p></p>
                        <em class="date"><span>기간: </span>2017.08.01 ~ 2017.12.31</em>
                    </div>
                </li>
            
                <li>
                    <div class="box-image">
                        <a href="../../culture-event/event/detail-view.aspx?idx=16688">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Event/Event/2017/0901/240_200.jpg" alt="CGV극장별+CGV X 푸드플라이 CGV 팝콘 딜리버리 서비스 런칭" />
                            </span>
                        </a>
                    </div>
                    <div class="box-contents">
                        <a href="../../culture-event/event/detail-view.aspx?idx=16688"><em class="text-rightblue">CGV극장별</em><strong>CGV X 푸드플라이 CGV 팝콘 딜리버리 서비스 런칭</strong></a>
                        <p></p>
                        <em class="date"><span>기간: </span>2017.09.01 ~ 2017.12.31</em>
                    </div>
                </li>
            
                <li>
                    <div class="box-image">
                        <a href="../../culture-event/event/detail-view.aspx?idx=16511">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Event/Event/2017/0727/innerb_w_list.jpg" alt="CGV극장별+[CGV5개극장]영화보며 피부관리하는 CGV 이너비 뷰티팩!" />
                            </span>
                        </a>
                    </div>
                    <div class="box-contents">
                        <a href="../../culture-event/event/detail-view.aspx?idx=16511"><em class="text-rightblue">CGV극장별</em><strong>[CGV5개극장]영화보며 피부관리하는 CGV 이너비 뷰티팩!</strong></a>
                        <p></p>
                        <em class="date"><span>기간: </span>2017.07.21 ~ 2017.12.31</em>
                    </div>
                </li>
