...
{
	chkClickLog('/mini예매');
	window.open('http://section.cgv.co.kr/mini/User/Login.aspx', '' , 'width=420,height=721,toolbar=no,scrollbars=yes');
}
...
function riaReserveClose(){
		...
		{
			window.open("http://section.cgv.co.kr/popup/popup.aspx?idx=135", 'RiaEvent', "width=320,height=385,top=150,left=345,toolbar=no,scrollbars=no,status=0,top=0,left=0");
		}
}
...
function FlashReserveMyCGV() {
	location.href = "http://section.cgv.co.kr/mycgv/diary/reserve/default.aspx";
}
...
function FlashGiftCon() {
	location.href = "http://section.cgv.co.kr/Shopping/giftcon/shop_list.aspx";
}

// 비밀번호 찾기
function fnFindAccount() {
	location.href = "http://section.cgv.co.kr/user/login/findAccount.aspx";
}
...
function FLogin(id, pwd, returnURL) {
	...
	if (returnURL != "n" && returnURL != "") {
		returnURL = "default4793.html?ria=y";
	} else {
	...
	if (keyObject) {
		...
		document.loginform.action = "http://section.cgv.co.kr/user/login/flogin.aspx";
...
function FIpin() {
	...
	if (keyObject) {
		location.href = "http://section.cgv.co.kr/user/ipin/Ipin_Common.aspx";
	}
	else {
		alert("진행중입니다. 화면이 완료된 후에 클릭해주세요.");
		document.location.reload();
...
function fnRiaOpen_Save(strValue) {
	...
	xmlRequest.Open("http://section.cgv.co.kr/GET", pageUrl, true);
...
function mainMoviePopup(movieidx) {
	...
	var so = new SWFObject("http://section.cgv.co.kr/detailPopup.swf", "mainMovepop", "710", "420", "", "#ffffff");
...
function watchMovie(args) {
	switch (args) {
		case "0":
			...
			location.href = "index.html?tabindex=4";
			break;
		case "1":
			//location.href = "/mycgv/diary/coupon/movie/list.aspx";
			location.href = "http://section.cgv.co.kr/gift/ticket/buy.aspx";
			break;
		case "2":
			//location.hef = "/mycgv/gift/gift01.aspx";
			location.href = "http://section.cgv.co.kr/reservation/ticket/ticket.aspx";
			break;
		case "3":
			location.href = "http://section.cgv.co.kr/reservation/card/ACard.aspx";
			break;
		case "4":
			location.href = "http://section.cgv.co.kr/mycgv/diary/coupon/reserve/list.aspx";
			break;
		default:
			location.href = "http://section.cgv.co.kr/mycgv/point/default.aspx";
			break;
	}
...
//당첨자 안내 		
function awardInfo() {
	location.href = "http://section.cgv.co.kr/event/winner/list.aspx";
}
...
function awardVote(args) {
	...
	switch (args) {
		case 0:
			location.href = "http://section.cgv.co.kr/openreview/cgvaward/cgvaward1.aspx";
			break;
		case 1:
			location.href = "http://section.cgv.co.kr/openreview/cgvaward/cgvaward2.aspx";
			break;
		default:
			location.href = "http://section.cgv.co.kr/openreview/cgvaward/cgvaward1.aspx";
			break;
...
//	명예의전당more 		
function moreHonor() {
	location.href = "http://section.cgv.co.kr/openreview/cgvaward/cgvaward3.aspx";
}
...
function magazineTab(args) {
	switch (args) {
		case 0:
			location.href = "http://section.cgv.co.kr/magazine/magazine/default.aspx?MovieNCode=1301";
			break;
		case 1:
			location.href = "http://section.cgv.co.kr/magazine/magazine/default.aspx?MovieNCode=1302";
			break;
		case 2:
			location.href = "http://section.cgv.co.kr/magazine/magazine/default.aspx?MovieNCode=1303";
			break;
		case 3:
			location.href = "http://section.cgv.co.kr/magazine/magazine/default.aspx?MovieNCode=1304";
			break;
		case 4:
			location.href = "http://section.cgv.co.kr/magazine/magazine/default.aspx?MovieNCode=1315";
			break;
		case 5:
			location.href = "http://section.cgv.co.kr/magazine/news/default.aspx";
			break;
		case 6:
			location.href = "http://section.cgv.co.kr/magazine/media/default.aspx";
			break;
		case 7:
			location.href = "http://section.cgv.co.kr/magazine/weekend/default.aspx";
			break;
		default:
			location.href = "magazine/default.html";
			break;
	}
...
// 리아 비회원
function GuestLogin() {
	location.href = "http://section.cgv.co.kr/user/guest/login_guest.aspx";
}
...
function getRegionArea() {
	...
	xmlRequest.open("http://section.cgv.co.kr/GET", Url, false);
	xmlRequest.send(null);
...
function GetRiaMovieInfo(CgvCD) {
	...
	if (midx == "") {
		LinkUrl = "http://section.cgv.co.kr/ria_MovieInfo_Notfound.html";
...
function popupQuickMini() {
	...
	var t = 20;
	var qmini = window.open('http://section.cgv.co.kr/mini/User/Login.aspx', 'qmini', 'left=' + l + ',top=' + t + ',menubar=1,resizable=1,width=' + w + ',height=' + h + ',scrollbars=1');
	//        qmini.moveTo(350, 10);
}
function popupQuickMiniForce() {
    ...
    var l = (screen.width - w) / 2;
    var t = 20;
    var qmini = window.open('http://section.cgv.co.kr/mini/User/Notice.aspx', 'qmini', 'left=' + l + ',top=' + t + ',menubar=1,resizable=1,width=' + w + ',height=' + h + ',scrollbars=1');
...
function CGV_DsicountCoupon() {
	...
	var OpenUrl = "http://section.cgv.co.kr/mycgv/diary/coupon/cgv_discount/pop_CGV_Discount_Coupon.aspx";
...
function CGV_DsicountCoupon_MyCgv() {
	...
	var OpenUrl = "http://section.cgv.co.kr/mycgv/diary/coupon/cgv_discount/list.aspx";
    window.open(OpenUrl);
}

function CJONE_DiscountCoupon_MyCgv() {

	var OpenUrl = "http://section.cgv.co.kr/mycgv/diary/coupon/cjms/list.aspx";
    window.open(OpenUrl);
}
...
function RealCoupon() {
    ...
    var OpenUrl = "http://section.cgv.co.kr/130419_ria_layer.html";
